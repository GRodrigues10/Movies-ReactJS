(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const f of document.querySelectorAll('link[rel="modulepreload"]'))c(f);new MutationObserver(f=>{for(const p of f)if(p.type==="childList")for(const x of p.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&c(x)}).observe(document,{childList:!0,subtree:!0});function s(f){const p={};return f.integrity&&(p.integrity=f.integrity),f.referrerPolicy&&(p.referrerPolicy=f.referrerPolicy),f.crossOrigin==="use-credentials"?p.credentials="include":f.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function c(f){if(f.ep)return;f.ep=!0;const p=s(f);fetch(f.href,p)}})();function Dg(l){return l&&l.__esModule&&Object.prototype.hasOwnProperty.call(l,"default")?l.default:l}var ms={exports:{}},al={};/**
 * @license React
 ...
 */var Lh;function Og(){if(Lh)return al;Lh=1;var l=Symbol.for("react.transitional.element"),o=Symbol.for("react.fragment");function s(c,f,p){var x=null;if(p!==void 0&&(x=""+p),f.key!==void 0&&(x=""+f.key),"key"in f){p={};for(var S in f)S!=="key"&&(p[S]=f[S])}else p=f;return f=p.ref,{$$typeof:l,type:c,key:x,ref:f!==void 0?f:null,props:p}}return al.Fragment=o,al.jsx=s,al.jsxs=s,al}var Gh;function Mg(){return Gh||(Gh=1,ms.exports=Og()),ms.exports}var d=Mg(),ps={exports:{}},it={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vh;function Bg(){return Vh||(Vh=1,(function(l){function o(C,G){var P=C.length;C.push(G);t:for(;0<P;){var ct=P-1>>>1,y=C[ct];if(0<f(y,G))C[ct]=G,C[P]=y,P=ct;else break t}}function s(C){return C.length===0?null:C[0]}function c(C){if(C.length===0)return null;var G=C[0],P=C.pop();if(P!==G){C[0]=P;t:for(var ct=0,y=C.length,B=y>>>1;ct<B;){var L=2*(ct+1)-1,Q=C[L],W=L+1,st=C[W];if(0>f(Q,P))W<y&&0>f(st,Q)?(C[ct]=st,C[W]=P,ct=W):(C[ct]=Q,C[L]=P,ct=L);else if(W<y&&0>f(st,P))C[ct]=st,C[W]=P,ct=W;else break t}}return G}function f(C,G){var P=C.sortIndex-G.sortIndex;return P!==0?P:C.id-G.id}if(l.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;l.unstable_now=function(){return p.now()}}else{var x=Date,S=x.now();l.unstable_now=function(){return x.now()-S}}var g=[],h=[],b=1,T=null,M=3,k=!1,H=!1,q=!1,X=!1,U=typeof setTimeout=="function"?setTimeout:null,Z=typeof clearTimeout=="function"?clearTimeout:null,Y=typeof setImmediate<"u"?setImmediate:null;function F(C){for(var G=s(h);G!==null;){if(G.callback===null)c(h);else if(G.startTime<=C)c(h),G.sortIndex=G.expirationTime,o(g,G);else break;G=s(h)}}function V(C){if(q=!1,F(C),!H)if(s(g)!==null)H=!0,I||(I=!0,Lt());else{var G=s(h);G!==null&&Gt(V,G.startTime-C)}}var I=!1,J=-1,wt=5,vt=-1;function ne(){return X?!0:!(l.unstable_now()-vt<wt)}function ie(){if(X=!1,I){var C=l.unstable_now();vt=C;var G=!0;try{t:{H=!1,q&&(q=!1,Z(J),J=-1),k=!0;var P=M;try{e:{for(F(C),T=s(g);T!==null&&!(T.expirationTime>C&&ne());){var ct=T.callback;if(typeof ct=="function"){T.callback=null,M=T.priorityLevel;var y=ct(T.expirationTime<=C);if(C=l.unstable_now(),typeof y=="function"){T.callback=y,F(C),G=!0;break e}T===s(g)&&c(g),F(C)}else c(g);T=s(g)}if(T!==null)G=!0;else{var B=s(h);B!==null&&Gt(V,B.startTime-C),G=!1}}break t}finally{T=null,M=P,k=!1}G=void 0}}finally{G?Lt():I=!1}}}var Lt;if(typeof Y=="function")Lt=function(){Y(ie)};else if(typeof MessageChannel<"u"){var $e=new MessageChannel,We=$e.port2;$e.port1.onmessage=ie,Lt=function(){We.postMessage(null)}}else Lt=function(){U(ie,0)};function Gt(C,G){J=U(function(){C(l.unstable_now())},G)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(C){C.callback=null},l.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):wt=0<C?Math.floor(1e3/C):5},l.unstable_getCurrentPriorityLevel=function(){return M},l.unstable_next=function(C){switch(M){case 1:case 2:case 3:var G=3;break;default:G=M}var P=M;M=G;try{return C()}finally{M=P}},l.unstable_requestPaint=function(){X=!0},l.unstable_runWithPriority=function(C,G){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var P=M;M=C;try{return G()}finally{M=P}},l.unstable_scheduleCallback=function(C,G,P){var ct=l.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?ct+P:ct):P=ct,C){case 1:var y=-1;break;case 2:y=250;break;case 5:y=1073741823;break;case 4:y=1e4;break;default:y=5e3}return y=P+y,C={id:b++,callback:G,priorityLevel:C,startTime:P,expirationTime:y,sortIndex:-1},P>ct?(C.sortIndex=P,o(h,C),s(g)===null&&C===s(h)&&(q?(Z(J),J=-1):q=!0,Gt(V,P-ct))):(C.sortIndex=y,o(g,C),H||k||(H=!0,I||(I=!0,Lt()))),C},l.unstable_shouldYield=ne,l.unstable_wrapCallback=function(C){var G=M;return function(){var P=M;M=G;try{return C.apply(this,arguments)}finally{M=P}}}})(vs)),vs}var Zh;function Ug(){return Zh||(Zh=1,xs.exports=Bg()),xs.exports}var bs={exports:{}},ee={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Kh;function kg(){if(Kh)return ee;Kh=1;var l=Bs();function o(g){var h="https://react.dev/errors/"+g;if(1<arguments.length){h+="?args[]="+encodeURIComponent(arguments[1]);for(var b=2;b<arguments.length;b++)h+="&args[]="+encodeURIComponent(arguments[b])}return"Minified React error #"+g+"; visit "+h+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function s(){}var c={d:{f:s,r:function(){throw Error(o(522))},D:s,C:s,L:s,m:s,X:s,S:s,M:s},p:0,findDOMNode:null},f=Symbol.for("react.portal");function p(g,h,b){var T=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:f,key:T==null?null:""+T,children:g,containerInfo:h,implementation:b}}var x=l.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function S(g,h){if(g==="font")return"";if(typeof h=="string")return h==="use-credentials"?h:""}return ee.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,ee.createPortal=function(g,h){var b=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!h||h.nodeType!==1&&h.nodeType!==9&&h.nodeType!==11)throw Error(o(299));return p(g,h,null,b)},ee.flushSync=function(g){var h=x.T,b=c.p;try{if(x.T=null,c.p=2,g)return g()}finally{x.T=h,c.p=b,c.d.f()}},ee.preconnect=function(g,h){typeof g=="string"&&(h?(h=h.crossOrigin,h=typeof h=="string"?h==="use-credentials"?h:"":void 0):h=null,c.d.C(g,h))},ee.prefetchDNS=function(g){typeof g=="string"&&c.d.D(g)},ee.preinit=function(g,h){if(typeof g=="string"&&h&&typeof h.as=="string"){var b=h.as,T=S(b,h.crossOrigin),M=typeof h.integrity=="string"?h.integrity:void 0,k=typeof h.fetchPriority=="string"?h.fetchPriority:void 0;b==="style"?c.d.S(g,typeof h.precedence=="string"?h.precedence:void 0,{crossOrigin:T,integrity:M,fetchPriority:k}):b==="script"&&c.d.X(g,{crossOrigin:T,integrity:M,fetchPriority:k,nonce:typeof h.nonce=="string"?h.nonce:void 0})}},ee.preinitModule=function(g,h){if(typeof g=="string")if(typeof h=="object"&&h!==null){if(h.as==null||h.as==="script"){var b=S(h.as,h.crossOrigin);c.d.M(g,{crossOrigin:b,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0})}}else h==null&&c.d.M(g)},ee.preload=function(g,h){if(typeof g=="string"&&typeof h=="object"&&h!==null&&typeof h.as=="string"){var b=h.as,T=S(b,h.crossOrigin);c.d.L(g,b,{crossOrigin:T,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0,type:typeof h.type=="string"?h.type:void 0,fetchPriority:typeof h.fetchPriority=="string"?h.fetchPriority:void 0,referrerPolicy:typeof h.referrerPolicy=="string"?h.referrerPolicy:void 0,imageSrcSet:typeof h.imageSrcSet=="string"?h.imageSrcSet:void 0,imageSizes:typeof h.imageSizes=="string"?h.imageSizes:void 0,media:typeof h.media=="string"?h.media:void 0})}},ee.preloadModule=function(g,h){if(typeof g=="string")if(h){var b=S(h.as,h.crossOrigin);c.d.m(g,{as:typeof h.as=="string"&&h.as!=="script"?h.as:void 0,crossOrigin:b,integrity:typeof h.integrity=="string"?h.integrity:void 0})}else c.d.m(g)},ee.requestFormReset=function(g){c.d.r(g)},ee.unstable_batchedUpdates=function(g,h){return g(h)},ee.useFormState=function(g,h,b){return x.H.useFormState(g,h,b)},ee.useFormStatus=function(){return x.H.useHostTransitionStatus()},ee.version="19.1.1",ee}var Jh;function Hg(){if(Jh)return bs.exports;Jh=1;function l(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(l)}catch(o){console.error(o)}}return l(),bs.exports=kg(),bs.exports}/**
 * @license React
...
`),j=m.split(`
`);for(i=a=0;a<v.length&&!v[a].includes("DetermineComponentFrameRoot");)a++;for(;i<j.length&&!j[i].includes("DetermineComponentFrameRoot");)i++;if(a===v.length||i===j.length)for(a=v.length-1,i=j.length-1;1<=a&&0<=i&&v[a]!==j[i];)i--;for(;1<=a&&0<=i;a--,i--)if(v[a]!==j[i]){if(a!==1||i!==1)do if(a--,i--,0>i||v[a]!==j[i]){var D=`
 ...
 *
 * @license MIT
 */var Fh="popstate";function Gg(l={}){function o(c,f){let{pathname:p,search:x,hash:S}=c.location;return js("",{pathname:p,search:x,hash:S},f.state&&f.state.usr||null,f.state&&f.state.key||"default")}function s(c,f){return typeof f=="string"?f:sl(f)}return Xg(o,s,null,l)}function Ct(l,o){if(l===!1||l===null||typeof l>"u")throw new Error(o)}function Ze(l,o){if(!l){typeof console<"u"&&console.warn(o);try{throw new Error(o)}catch{}}}function Qg(){return Math.random().toString(36).substring(2,10)}function Ih(l,o){return{usr:l.state,key:l.key,idx:o}}function js(l,o,s=null,c){return{pathname:typeof l=="string"?l:l.pathname,search:"",hash:"",...typeof o=="string"?ai(o):o,state:s,key:o&&o.key||c||Qg()}}function sl({pathname:l="/",search:o="",hash:s=""}){return o&&o!=="?"&&(l+=o.charAt(0)==="?"?o:"?"+o),s&&s!=="#"&&(l+=s.charAt(0)==="#"?s:"#"+s),l}function ai(l){let o={};if(l){let s=l.indexOf("#");s>=0&&(o.hash=l.substring(s),l=l.substring(0,s));let c=l.indexOf("?");c>=0&&(o.search=l.substring(c),l=l.substring(0,c)),l&&(o.pathname=l)}return o}function Xg(l,o,s,c={}){let{window:f=document.defaultView,v5Compat:p=!1}=c,x=f.history,S="POP",g=null,h=b();h==null&&(h=0,x.replaceState({...x.state,idx:h},""));function b(){return(x.state||{idx:null}).idx}function T(){S="POP";let X=b(),U=X==null?null:X-h;h=X,g&&g({action:S,location:q.location,delta:U})}function M(X,U){S="PUSH";let Z=js(q.location,X,U);h=b()+1;let Y=Ih(Z,h),F=q.createHref(Z);try{x.pushState(Y,"",F)}catch(V){if(V instanceof DOMException&&V.name==="DataCloneError")throw V;f.location.assign(F)}p&&g&&g({action:S,location:q.location,delta:1})}function k(X,U){S="REPLACE";let Z=js(q.location,X,U);h=b();let Y=Ih(Z,h),F=q.createHref(Z);x.replaceState(Y,"",F),p&&g&&g({action:S,location:q.location,delta:0})}function H(X){return Vg(X)}let q={get action(){return S},get location(){return l(f,x)},listen(X){if(g)throw new Error("A history only accepts one active listener");return f.addEventListener(Fh,T),g=X,()=>{f.removeEventListener(Fh,T),g=null}},createHref(X){return o(f,X)},createURL:H,encodeLocation(X){let U=H(X);return{pathname:U.pathname,search:U.search,hash:U.hash}},push:M,replace:k,go(X){return x.go(X)}};return q}function Vg(l,o=!1){let s="http://localhost";typeof window<"u"&&(s=window.location.origin!=="null"?window.location.origin:window.location.href),Ct(s,"No window.location.(origin|href) available to create URL");let c=typeof l=="string"?l:sl(l);return c=c.replace(/ $/,"%20"),!o&&c.startsWith("//")&&(c=s+c),new URL(c,s)}function ym(l,o,s="/"){return Zg(l,o,s,!1)}function Zg(l,o,s,c){let f=typeof o=="string"?ai(o):o,p=gn(f.pathname||"/",s);if(p==null)return null;let x=wm(l);Kg(x);let S=null;for(let g=0;S==null&&g<x.length;++g){let h=i1(p);S=n1(x[g],h,c)}return S}function wm(l,o=[],s=[],c="",f=!1){let p=(x,S,g=f,h)=>{let b={relativePath:h===void 0?x.path||"":h,caseSensitive:x.caseSensitive===!0,childrenIndex:S,route:x};if(b.relativePath.startsWith("/")){if(!b.relativePath.startsWith(c)&&g)return;Ct(b.relativePath.startsWith(c),`Absolute route path "${b.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),b.relativePath=b.relativePath.slice(c.length)}let T=pn([c,b.relativePath]),M=s.concat(b);x.children&&x.children.length>0&&(Ct(x.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${T}".`),wm(x.children,o,M,T,g)),!(x.path==null&&!x.index)&&o.push({path:T,score:t1(T,x.index),routesMeta:M})};return l.forEach((x,S)=>{if(x.path===""||!x.path?.includes("?"))p(x,S);else for(let g of Sm(x.path))p(x,S,!0,g)}),o}function Sm(l){let o=l.split("/");if(o.length===0)return[];let[s,...c]=o,f=s.endsWith("?"),p=s.replace(/\?$/,"");if(c.length===0)return f?[p,""]:[p];let x=Sm(c.join("/")),S=[];return S.push(...x.map(g=>g===""?p:[p,g].join("/"))),f&&S.push(...x),S.map(g=>l.startsWith("/")&&g===""?"/":g)}function Kg(l){l.sort((o,s)=>o.score!==s.score?s.score-o.score:e1(o.routesMeta.map(c=>c.childrenIndex),s.routesMeta.map(c=>c.childrenIndex)))}var Jg=/^:[\w-]+$/,$g=3,Wg=2,Fg=1,Ig=10,Pg=-2,Ph=l=>l==="*";function t1(l,o){let s=l.split("/"),c=s.length;return s.some(Ph)&&(c+=Pg),o&&(c+=Wg),s.filter(f=>!Ph(f)).reduce((f,p)=>f+(Jg.test(p)?$g:p===""?Fg:Ig),c)}function e1(l,o){return l.length===o.length&&l.slice(0,-1).every((c,f)=>c===o[f])?l[l.length-1]-o[o.length-1]:0}function n1(l,o,s=!1){let{routesMeta:c}=l,f={},p="/",x=[];for(let S=0;S<c.length;++S){let g=c[S],h=S===c.length-1,b=p==="/"?o:o.slice(p.length)||"/",T=qr({path:g.relativePath,caseSensitive:g.caseSensitive,end:h},b),M=g.route;if(!T&&h&&s&&!c[c.length-1].route.index&&(T=qr({path:g.relativePath,caseSensitive:g.caseSensitive,end:!1},b)),!T)return null;Object.assign(f,T.params),x.push({params:f,pathname:pn([p,T.pathname]),pathnameBase:c1(pn([p,T.pathnameBase])),route:M}),T.pathnameBase!=="/"&&(p=pn([p,T.pathnameBase]))}return x}function qr(l,o){typeof l=="string"&&(l={path:l,caseSensitive:!1,end:!0});let[s,c]=a1(l.path,l.caseSensitive,l.end),f=o.match(s);if(!f)return null;let p=f[0],x=p.replace(/(.)\/+$/,"$1"),S=f.slice(1);return{params:c.reduce((h,{paramName:b,isOptional:T},M)=>{if(b==="*"){let H=S[M]||"";x=p.slice(0,p.length-H.length).replace(/(.)\/+$/,"$1")}const k=S[M];return T&&!k?h[b]=void 0:h[b]=(k||"").replace(/%2F/g,"/"),h},{}),pathname:p,pathnameBase:x,pattern:l}}function a1(l,o=!1,s=!0){Ze(l==="*"||!l.endsWith("*")||l.endsWith("/*"),`Route path "${l}" will be treated as if it were "${l.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${l.replace(/\*$/,"/*")}".`);let c=[],f="^"+l.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(x,S,g)=>(c.push({paramName:S,isOptional:g!=null}),g?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return l.endsWith("*")?(c.push({paramName:"*"}),f+=l==="*"||l==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):s?f+="\\/*$":l!==""&&l!=="/"&&(f+="(?:(?=\\/|$))"),[new RegExp(f,o?void 0:"i"),c]}function i1(l){try{return l.split("/").map(o=>decodeURIComponent(o).replace(/\//g,"%2F")).join("/")}catch(o){return Ze(!1,`The URL path "${l}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${o}).`),l}}function gn(l,o){if(o==="/")return l;if(!l.toLowerCase().startsWith(o.toLowerCase()))return null;let s=o.endsWith("/")?o.length-1:o.length,c=l.charAt(s);return c&&c!=="/"?null:l.slice(s)||"/"}function l1(l,o="/"){let{pathname:s,search:c="",hash:f=""}=typeof l=="string"?ai(l):l;return{pathname:s?s.startsWith("/")?s:r1(s,o):o,search:s1(c),hash:u1(f)}}function r1(l,o){let s=o.replace(/\/+$/,"").split("/");return l.split("/").forEach(f=>{f===".."?s.length>1&&s.pop():f!=="."&&s.push(f)}),s.length>1?s.join("/"):"/"}function ys(l,o,s,c){return`Cannot include a '${l}' character in a manually specified \`to.${o}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${s}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function o1(l){return l.filter((o,s)=>s===0||o.route.path&&o.route.path.length>0)}function zm(l){let o=o1(l);return o.map((s,c)=>c===o.length-1?s.pathname:s.pathnameBase)}function Am(l,o,s,c=!1){let f;typeof l=="string"?f=ai(l):(f={...l},Ct(!f.pathname||!f.pathname.includes("?"),ys("?","pathname","search",f)),Ct(!f.pathname||!f.pathname.includes("#"),ys("#","pathname","hash",f)),Ct(!f.search||!f.search.includes("#"),ys("#","search","hash",f)));let p=l===""||f.pathname==="",x=p?"/":f.pathname,S;if(x==null)S=s;else{let T=o.length-1;if(!c&&x.startsWith("..")){let M=x.split("/");for(;M[0]==="..";)M.shift(),T-=1;f.pathname=M.join("/")}S=T>=0?o[T]:"/"}let g=l1(f,S),h=x&&x!=="/"&&x.endsWith("/"),b=(p||x===".")&&s.endsWith("/");return!g.pathname.endsWith("/")&&(h||b)&&(g.pathname+="/"),g}var pn=l=>l.join("/").replace(/\/\/+/g,"/"),c1=l=>l.replace(/\/+$/,"").replace(/^\/*/,"/"),s1=l=>!l||l==="?"?"":l.startsWith("?")?l:"?"+l,u1=l=>!l||l==="#"?"":l.startsWith("#")?l:"#"+l;function f1(l){return l!=null&&typeof l.status=="number"&&typeof l.statusText=="string"&&typeof l.internal=="boolean"&&"data"in l}var Em=["POST","PUT","PATCH","DELETE"];new Set(Em);var d1=["GET",...Em];new Set(d1);var ii=A.createContext(null);ii.displayName="DataRouter";var Zr=A.createContext(null);Zr.displayName="DataRouterState";A.createContext(!1);var jm=A.createContext({isTransitioning:!1});jm.displayName="ViewTransition";var h1=A.createContext(new Map);h1.displayName="Fetchers";var m1=A.createContext(null);m1.displayName="Await";var Ke=A.createContext(null);Ke.displayName="Navigation";var fl=A.createContext(null);fl.displayName="Location";var Je=A.createContext({outlet:null,matches:[],isDataRoute:!1});Je.displayName="Route";var Us=A.createContext(null);Us.displayName="RouteError";function p1(l,{relative:o}={}){Ct(dl(),"useHref() may be used only in the context of a <Router> component.");let{basename:s,navigator:c}=A.useContext(Ke),{hash:f,pathname:p,search:x}=hl(l,{relative:o}),S=p;return s!=="/"&&(S=p==="/"?s:pn([s,p])),c.createHref({pathname:S,search:x,hash:f})}function dl(){return A.useContext(fl)!=null}function xn(){return Ct(dl(),"useLocation() may be used only in the context of a <Router> component."),A.useContext(fl).location}var Rm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Nm(l){A.useContext(Ke).static||A.useLayoutEffect(l)}function Bt(){let{isDataRoute:l}=A.useContext(Je);return l?T1():g1()}function g1(){Ct(dl(),"useNavigate() may be used only in the context of a <Router> component.");let l=A.useContext(ii),{basename:o,navigator:s}=A.useContext(Ke),{matches:c}=A.useContext(Je),{pathname:f}=xn(),p=JSON.stringify(zm(c)),x=A.useRef(!1);return Nm(()=>{x.current=!0}),A.useCallback((g,h={})=>{if(Ze(x.current,Rm),!x.current)return;if(typeof g=="number"){s.go(g);return}let b=Am(g,JSON.parse(p),f,h.relative==="path");l==null&&o!=="/"&&(b.pathname=b.pathname==="/"?o:pn([o,b.pathname])),(h.replace?s.replace:s.push)(b,h.state,h)},[o,s,p,f,l])}A.createContext(null);function x1(){let{matches:l}=A.useContext(Je),o=l[l.length-1];return o?o.params:{}}function hl(l,{relative:o}={}){let{matches:s}=A.useContext(Je),{pathname:c}=xn(),f=JSON.stringify(zm(s));return A.useMemo(()=>Am(l,JSON.parse(f),c,o==="path"),[l,f,c,o])}function v1(l,o){return Tm(l,o)}function Tm(l,o,s,c){Ct(dl(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:f}=A.useContext(Ke),{matches:p}=A.useContext(Je),x=p[p.length-1],S=x?x.params:{},g=x?x.pathname:"/",h=x?x.pathnameBase:"/",b=x&&x.route;{let U=b&&b.path||"";Cm(g,!b||U.endsWith("*")||U.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${g}" (under <Route path="${U}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let T=xn(),M;if(o){let U=typeof o=="string"?ai(o):o;Ct(h==="/"||U.pathname?.startsWith(h),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${h}" but pathname "${U.pathname}" was given in the \`location\` prop.`),M=U}else M=T;let k=M.pathname||"/",H=k;if(h!=="/"){let U=h.replace(/^\//,"").split("/");H="/"+k.replace(/^\//,"").split("/").slice(U.length).join("/")}let q=ym(l,{pathname:H});Ze(b||q!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),Ze(q==null||q[q.length-1].route.element!==void 0||q[q.length-1].route.Component!==void 0||q[q.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let X=z1(q&&q.map(U=>Object.assign({},U,{params:Object.assign({},S,U.params),pathname:pn([h,f.encodeLocation?f.encodeLocation(U.pathname).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?h:pn([h,f.encodeLocation?f.encodeLocation(U.pathnameBase).pathname:U.pathnameBase])})),p,s,c);return o&&X?A.createElement(fl.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},X):X}function b1(){let l=N1(),o=f1(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),s=l instanceof Error?l.stack:null,c="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:c},p={padding:"2px 4px",backgroundColor:c},x=null;return console.error("Error handled by React Router default ErrorBoundary:",l),x=A.createElement(A.Fragment,null,A.createElement("p",null,"💿 Hey developer 👋"),A.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",A.createElement("code",{style:p},"ErrorBoundary")," or"," ",A.createElement("code",{style:p},"errorElement")," prop on your route.")),A.createElement(A.Fragment,null,A.createElement("h2",null,"Unexpected Application Error!"),A.createElement("h3",{style:{fontStyle:"italic"}},o),s?A.createElement("pre",{style:f},s):null,x)}var y1=A.createElement(b1,null),w1=class extends A.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,o){return o.location!==l.location||o.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:o.error,location:o.location,revalidation:l.revalidation||o.revalidation}}componentDidCatch(l,o){console.error("React Router caught the following error during render",l,o)}render(){return this.state.error!==void 0?A.createElement(Je.Provider,{value:this.props.routeContext},A.createElement(Us.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function S1({routeContext:l,match:o,children:s}){let c=A.useContext(ii);return c&&c.static&&c.staticContext&&(o.route.errorElement||o.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=o.route.id),A.createElement(Je.Provider,{value:l},s)}function z1(l,o=[],s=null,c=null){if(l==null){if(!s)return null;if(s.errors)l=s.matches;else if(o.length===0&&!s.initialized&&s.matches.length>0)l=s.matches;else return null}let f=l,p=s?.errors;if(p!=null){let g=f.findIndex(h=>h.route.id&&p?.[h.route.id]!==void 0);Ct(g>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),f=f.slice(0,Math.min(f.length,g+1))}let x=!1,S=-1;if(s)for(let g=0;g<f.length;g++){let h=f[g];if((h.route.HydrateFallback||h.route.hydrateFallbackElement)&&(S=g),h.route.id){let{loaderData:b,errors:T}=s,M=h.route.loader&&!b.hasOwnProperty(h.route.id)&&(!T||T[h.route.id]===void 0);if(h.route.lazy||M){x=!0,S>=0?f=f.slice(0,S+1):f=[f[0]];break}}}return f.reduceRight((g,h,b)=>{let T,M=!1,k=null,H=null;s&&(T=p&&h.route.id?p[h.route.id]:void 0,k=h.route.errorElement||y1,x&&(S<0&&b===0?(Cm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),M=!0,H=null):S===b&&(M=!0,H=h.route.hydrateFallbackElement||null)));let q=o.concat(f.slice(0,b+1)),X=()=>{let U;return T?U=k:M?U=H:h.route.Component?U=A.createElement(h.route.Component,null):h.route.element?U=h.route.element:U=g,A.createElement(S1,{match:h,routeContext:{outlet:g,matches:q,isDataRoute:s!=null},children:U})};return s&&(h.route.ErrorBoundary||h.route.errorElement||b===0)?A.createElement(w1,{location:s.location,revalidation:s.revalidation,component:k,error:T,children:X(),routeContext:{outlet:null,matches:q,isDataRoute:!0}}):X()},null)}function ks(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function A1(l){let o=A.useContext(ii);return Ct(o,ks(l)),o}function E1(l){let o=A.useContext(Zr);return Ct(o,ks(l)),o}function j1(l){let o=A.useContext(Je);return Ct(o,ks(l)),o}function Hs(l){let o=j1(l),s=o.matches[o.matches.length-1];return Ct(s.route.id,`${l} can only be used on routes that contain a unique "id"`),s.route.id}function R1(){return Hs("useRouteId")}function N1(){let l=A.useContext(Us),o=E1("useRouteError"),s=Hs("useRouteError");return l!==void 0?l:o.errors?.[s]}function T1(){let{router:l}=A1("useNavigate"),o=Hs("useNavigate"),s=A.useRef(!1);return Nm(()=>{s.current=!0}),A.useCallback(async(f,p={})=>{Ze(s.current,Rm),s.current&&(typeof f=="number"?l.navigate(f):await l.navigate(f,{fromRouteId:o,...p}))},[l,o])}var tm={};function Cm(l,o,s){!o&&!tm[l]&&(tm[l]=!0,Ze(!1,s))}A.memo(C1);function C1({routes:l,future:o,state:s}){return Tm(l,void 0,s,o)}function rl(l){Ct(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function D1({basename:l="/",children:o=null,location:s,navigationType:c="POP",navigator:f,static:p=!1}){Ct(!dl(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let x=l.replace(/^\/*/,"/"),S=A.useMemo(()=>({basename:x,navigator:f,static:p,future:{}}),[x,f,p]);typeof s=="string"&&(s=ai(s));let{pathname:g="/",search:h="",hash:b="",state:T=null,key:M="default"}=s,k=A.useMemo(()=>{let H=gn(g,x);return H==null?null:{location:{pathname:H,search:h,hash:b,state:T,key:M},navigationType:c}},[x,g,h,b,T,M,c]);return Ze(k!=null,`<Router basename="${x}"> is not able to match the URL "${g}${h}${b}" because it does not start with the basename, so the <Router> won't render anything.`),k==null?null:A.createElement(Ke.Provider,{value:S},A.createElement(fl.Provider,{children:o,value:k}))}function O1({children:l,location:o}){return v1(Rs(l),o)}function Rs(l,o=[]){let s=[];return A.Children.forEach(l,(c,f)=>{if(!A.isValidElement(c))return;let p=[...o,f];if(c.type===A.Fragment){s.push.apply(s,Rs(c.props.children,p));return}Ct(c.type===rl,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ct(!c.props.index||!c.props.children,"An index route cannot have child routes.");let x={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(x.children=Rs(c.props.children,p)),s.push(x)}),s}var Or="get",Mr="application/x-www-form-urlencoded";function Kr(l){return l!=null&&typeof l.tagName=="string"}function M1(l){return Kr(l)&&l.tagName.toLowerCase()==="button"}function _1(l){return Kr(l)&&l.tagName.toLowerCase()==="form"}function B1(l){return Kr(l)&&l.tagName.toLowerCase()==="input"}function U1(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function k1(l,o){return l.button===0&&(!o||o==="_self")&&!U1(l)}var Tr=null;function H1(){if(Tr===null)try{new FormData(document.createElement("form"),0),Tr=!1}catch{Tr=!0}return Tr}var q1=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function ws(l){return l!=null&&!q1.has(l)?(Ze(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Mr}"`),null):l}function Y1(l,o){let s,c,f,p,x;if(_1(l)){let S=l.getAttribute("action");c=S?gn(S,o):null,s=l.getAttribute("method")||Or,f=ws(l.getAttribute("enctype"))||Mr,p=new FormData(l)}else if(M1(l)||B1(l)&&(l.type==="submit"||l.type==="image")){let S=l.form;if(S==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let g=l.getAttribute("formaction")||S.getAttribute("action");if(c=g?gn(g,o):null,s=l.getAttribute("formmethod")||S.getAttribute("method")||Or,f=ws(l.getAttribute("formenctype"))||ws(S.getAttribute("enctype"))||Mr,p=new FormData(S,l),!H1()){let{name:h,type:b,value:T}=l;if(b==="image"){let M=h?`${h}.`:"";p.append(`${M}x`,"0"),p.append(`${M}y`,"0")}else h&&p.append(h,T)}}else{if(Kr(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');s=Or,c=null,f=Mr,x=l}return p&&f==="text/plain"&&(x=p,p=void 0),{action:c,method:s.toLowerCase(),encType:f,formData:p,body:x}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function qs(l,o){if(l===!1||l===null||typeof l>"u")throw new Error(o)}function L1(l,o,s){let c=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return c.pathname==="/"?c.pathname=`_root.${s}`:o&&gn(c.pathname,o)==="/"?c.pathname=`${o.replace(/\/$/,"")}/_root.${s}`:c.pathname=`${c.pathname.replace(/\/$/,"")}.${s}`,c}async function G1(l,o){if(l.id in o)return o[l.id];try{let s=await import(l.module);return o[l.id]=s,s}catch(s){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(s),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Q1(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function X1(l,o,s){let c=await Promise.all(l.map(async f=>{let p=o.routes[f.route.id];if(p){let x=await G1(p,s);return x.links?x.links():[]}return[]}));return J1(c.flat(1).filter(Q1).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function em(l,o,s,c,f,p){let x=(g,h)=>s[h]?g.route.id!==s[h].route.id:!0,S=(g,h)=>s[h].pathname!==g.pathname||s[h].route.path?.endsWith("*")&&s[h].params["*"]!==g.params["*"];return p==="assets"?o.filter((g,h)=>x(g,h)||S(g,h)):p==="data"?o.filter((g,h)=>{let b=c.routes[g.route.id];if(!b||!b.hasLoader)return!1;if(x(g,h)||S(g,h))return!0;if(g.route.shouldRevalidate){let T=g.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:s[0]?.params||{},nextUrl:new URL(l,window.origin),nextParams:g.params,defaultShouldRevalidate:!0});if(typeof T=="boolean")return T}return!0}):[]}function V1(l,o,{includeHydrateFallback:s}={}){return Z1(l.map(c=>{let f=o.routes[c.route.id];if(!f)return[];let p=[f.module];return f.clientActionModule&&(p=p.concat(f.clientActionModule)),f.clientLoaderModule&&(p=p.concat(f.clientLoaderModule)),s&&f.hydrateFallbackModule&&(p=p.concat(f.hydrateFallbackModule)),f.imports&&(p=p.concat(f.imports)),p}).flat(1))}function Z1(l){return[...new Set(l)]}function K1(l){let o={},s=Object.keys(l).sort();for(let c of s)o[c]=l[c];return o}function J1(l,o){let s=new Set;return new Set(o),l.reduce((c,f)=>{let p=JSON.stringify(K1(f));return s.has(p)||(s.add(p),c.push({key:p,link:f})),c},[])}function Dm(){let l=A.useContext(ii);return qs(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function $1(){let l=A.useContext(Zr);return qs(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var Ys=A.createContext(void 0);Ys.displayName="FrameworkContext";function Om(){let l=A.useContext(Ys);return qs(l,"You must render this element inside a <HydratedRouter> element"),l}function W1(l,o){let s=A.useContext(Ys),[c,f]=A.useState(!1),[p,x]=A.useState(!1),{onFocus:S,onBlur:g,onMouseEnter:h,onMouseLeave:b,onTouchStart:T}=o,M=A.useRef(null);A.useEffect(()=>{if(l==="render"&&x(!0),l==="viewport"){let q=U=>{U.forEach(Z=>{x(Z.isIntersecting)})},X=new IntersectionObserver(q,{threshold:.5});return M.current&&X.observe(M.current),()=>{X.disconnect()}}},[l]),A.useEffect(()=>{if(c){let q=setTimeout(()=>{x(!0)},100);return()=>{clearTimeout(q)}}},[c]);let k=()=>{f(!0)},H=()=>{f(!1),x(!1)};return s?l!=="intent"?[p,M,{}]:[p,M,{onFocus:ll(S,k),onBlur:ll(g,H),onMouseEnter:ll(h,k),onMouseLeave:ll(b,H),onTouchStart:ll(T,k)}]:[!1,M,{}]}function ll(l,o){return s=>{l&&l(s),s.defaultPrevented||o(s)}}function F1({page:l,...o}){let{router:s}=Dm(),c=A.useMemo(()=>ym(s.routes,l,s.basename),[s.routes,l,s.basename]);return c?A.createElement(P1,{page:l,matches:c,...o}):null}function I1(l){let{manifest:o,routeModules:s}=Om(),[c,f]=A.useState([]);return A.useEffect(()=>{let p=!1;return X1(l,o,s).then(x=>{p||f(x)}),()=>{p=!0}},[l,o,s]),c}function P1({page:l,matches:o,...s}){let c=xn(),{manifest:f,routeModules:p}=Om(),{basename:x}=Dm(),{loaderData:S,matches:g}=$1(),h=A.useMemo(()=>em(l,o,g,f,c,"data"),[l,o,g,f,c]),b=A.useMemo(()=>em(l,o,g,f,c,"assets"),[l,o,g,f,c]),T=A.useMemo(()=>{if(l===c.pathname+c.search+c.hash)return[];let H=new Set,q=!1;if(o.forEach(U=>{let Z=f.routes[U.route.id];!Z||!Z.hasLoader||(!h.some(Y=>Y.route.id===U.route.id)&&U.route.id in S&&p[U.route.id]?.shouldRevalidate||Z.hasClientLoader?q=!0:H.add(U.route.id))}),H.size===0)return[];let X=L1(l,x,"data");return q&&H.size>0&&X.searchParams.set("_routes",o.filter(U=>H.has(U.route.id)).map(U=>U.route.id).join(",")),[X.pathname+X.search]},[x,S,c,f,h,o,l,p]),M=A.useMemo(()=>V1(b,f),[b,f]),k=I1(b);return A.createElement(A.Fragment,null,T.map(H=>A.createElement("link",{key:H,rel:"prefetch",as:"fetch",href:H,...s})),M.map(H=>A.createElement("link",{key:H,rel:"modulepreload",href:H,...s})),k.map(({key:H,link:q})=>A.createElement("link",{key:H,nonce:s.nonce,...q})))}function tx(...l){return o=>{l.forEach(s=>{typeof s=="function"?s(o):s!=null&&(s.current=o)})}}var Mm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Mm&&(window.__reactRouterVersion="7.8.1")}catch{}function ex({basename:l,children:o,window:s}){let c=A.useRef();c.current==null&&(c.current=Gg({window:s,v5Compat:!0}));let f=c.current,[p,x]=A.useState({action:f.action,location:f.location}),S=A.useCallback(g=>{A.startTransition(()=>x(g))},[x]);return A.useLayoutEffect(()=>f.listen(S),[f,S]),A.createElement(D1,{basename:l,children:o,location:p.location,navigationType:p.action,navigator:f})}var _m=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ls=A.forwardRef(function({onClick:o,discover:s="render",prefetch:c="none",relative:f,reloadDocument:p,replace:x,state:S,target:g,to:h,preventScrollReset:b,viewTransition:T,...M},k){let{basename:H}=A.useContext(Ke),q=typeof h=="string"&&_m.test(h),X,U=!1;if(typeof h=="string"&&q&&(X=h,Mm))try{let vt=new URL(window.location.href),ne=h.startsWith("//")?new URL(vt.protocol+h):new URL(h),ie=gn(ne.pathname,H);ne.origin===vt.origin&&ie!=null?h=ie+ne.search+ne.hash:U=!0}catch{Ze(!1,`<Link to="${h}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let Z=p1(h,{relative:f}),[Y,F,V]=W1(c,M),I=lx(h,{replace:x,state:S,target:g,preventScrollReset:b,relative:f,viewTransition:T});function J(vt){o&&o(vt),vt.defaultPrevented||I(vt)}let wt=A.createElement("a",{...M,...V,href:X||Z,onClick:U||p?o:J,ref:tx(k,F),target:g,"data-discover":!q&&s==="render"?"true":void 0});return Y&&!q?A.createElement(A.Fragment,null,wt,A.createElement(F1,{page:Z})):wt});Ls.displayName="Link";var nx=A.forwardRef(function({"aria-current":o="page",caseSensitive:s=!1,className:c="",end:f=!1,style:p,to:x,viewTransition:S,children:g,...h},b){let T=hl(x,{relative:h.relative}),M=xn(),k=A.useContext(Zr),{navigator:H,basename:q}=A.useContext(Ke),X=k!=null&&ux(T)&&S===!0,U=H.encodeLocation?H.encodeLocation(T).pathname:T.pathname,Z=M.pathname,Y=k&&k.navigation&&k.navigation.location?k.navigation.location.pathname:null;s||(Z=Z.toLowerCase(),Y=Y?Y.toLowerCase():null,U=U.toLowerCase()),Y&&q&&(Y=gn(Y,q)||Y);const F=U!=="/"&&U.endsWith("/")?U.length-1:U.length;let V=Z===U||!f&&Z.startsWith(U)&&Z.charAt(F)==="/",I=Y!=null&&(Y===U||!f&&Y.startsWith(U)&&Y.charAt(U.length)==="/"),J={isActive:V,isPending:I,isTransitioning:X},wt=V?o:void 0,vt;typeof c=="function"?vt=c(J):vt=[c,V?"active":null,I?"pending":null,X?"transitioning":null].filter(Boolean).join(" ");let ne=typeof p=="function"?p(J):p;return A.createElement(Ls,{...h,"aria-current":wt,className:vt,ref:b,style:ne,to:x,viewTransition:S},typeof g=="function"?g(J):g)});nx.displayName="NavLink";var ax=A.forwardRef(({discover:l="render",fetcherKey:o,navigate:s,reloadDocument:c,replace:f,state:p,method:x=Or,action:S,onSubmit:g,relative:h,preventScrollReset:b,viewTransition:T,...M},k)=>{let H=cx(),q=sx(S,{relative:h}),X=x.toLowerCase()==="get"?"get":"post",U=typeof S=="string"&&_m.test(S),Z=Y=>{if(g&&g(Y),Y.defaultPrevented)return;Y.preventDefault();let F=Y.nativeEvent.submitter,V=F?.getAttribute("formmethod")||x;H(F||Y.currentTarget,{fetcherKey:o,method:V,navigate:s,replace:f,state:p,relative:h,preventScrollReset:b,viewTransition:T})};return A.createElement("form",{ref:k,method:X,action:q,onSubmit:c?g:Z,...M,"data-discover":!U&&l==="render"?"true":void 0})});ax.displayName="Form";function ix(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Bm(l){let o=A.useContext(ii);return Ct(o,ix(l)),o}function lx(l,{target:o,replace:s,state:c,preventScrollReset:f,relative:p,viewTransition:x}={}){let S=Bt(),g=xn(),h=hl(l,{relative:p});return A.useCallback(b=>{if(k1(b,o)){b.preventDefault();let T=s!==void 0?s:sl(g)===sl(h);S(l,{replace:T,state:c,preventScrollReset:f,relative:p,viewTransition:x})}},[g,S,h,s,c,o,l,f,p,x])}var rx=0,ox=()=>`__${String(++rx)}__`;function cx(){let{router:l}=Bm("useSubmit"),{basename:o}=A.useContext(Ke),s=R1();return A.useCallback(async(c,f={})=>{let{action:p,method:x,encType:S,formData:g,body:h}=Y1(c,o);if(f.navigate===!1){let b=f.fetcherKey||ox();await l.fetch(b,s,f.action||p,{preventScrollReset:f.preventScrollReset,formData:g,body:h,formMethod:f.method||x,formEncType:f.encType||S,flushSync:f.flushSync})}else await l.navigate(f.action||p,{preventScrollReset:f.preventScrollReset,formData:g,body:h,formMethod:f.method||x,formEncType:f.encType||S,replace:f.replace,state:f.state,fromRouteId:s,flushSync:f.flushSync,viewTransition:f.viewTransition})},[l,o,s])}function sx(l,{relative:o}={}){let{basename:s}=A.useContext(Ke),c=A.useContext(Je);Ct(c,"useFormAction must be used inside a RouteContext");let[f]=c.matches.slice(-1),p={...hl(l||".",{relative:o})},x=xn();if(l==null){p.search=x.search;let S=new URLSearchParams(p.search),g=S.getAll("index");if(g.some(b=>b==="")){S.delete("index"),g.filter(T=>T).forEach(T=>S.append("index",T));let b=S.toString();p.search=b?`?${b}`:""}}return(!l||l===".")&&f.route.index&&(p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index"),s!=="/"&&(p.pathname=p.pathname==="/"?s:pn([s,p.pathname])),sl(p)}function ux(l,{relative:o}={}){let s=A.useContext(jm);Ct(s!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=Bm("useViewTransitionState"),f=hl(l,{relative:o});if(!s.isTransitioning)return!1;let p=gn(s.currentLocation.pathname,c)||s.currentLocation.pathname,x=gn(s.nextLocation.pathname,c)||s.nextLocation.pathname;return qr(f.pathname,x)!=null||qr(f.pathname,p)!=null}var ue=function(){return ue=Object.assign||function(o){for(var s,c=1,f=arguments.length;c<f;c++){s=arguments[c];for(var p in s)Object.prototype.hasOwnProperty.call(s,p)&&(o[p]=s[p])}return o},ue.apply(this,arguments)};function Yr(l,o,s){if(s||arguments.length===2)for(var c=0,f=o.length,p;c<f;c++)(p||!(c in o))&&(p||(p=Array.prototype.slice.call(o,0,c)),p[c]=o[c]);return l.concat(p||Array.prototype.slice.call(o))}var Rt="-ms-",cl="-moz-",xt="-webkit-",Um="comm",Jr="rule",Gs="decl",fx="@import",km="@keyframes",dx="@layer",Hm=Math.abs,Qs=String.fromCharCode,Ns=Object.assign;function hx(l,o){return Jt(l,0)^45?(((o<<2^Jt(l,0))<<2^Jt(l,1))<<2^Jt(l,2))<<2^Jt(l,3):0}function qm(l){return l.trim()}function mn(l,o){return(l=o.exec(l))?l[0]:l}function lt(l,o,s){return l.replace(o,s)}function _r(l,o,s){return l.indexOf(o,s)}function Jt(l,o){return l.charCodeAt(o)|0}function Ia(l,o,s){return l.slice(o,s)}function Ve(l){return l.length}function Ym(l){return l.length}function ol(l,o){return o.push(l),l}function mx(l,o){return l.map(o).join("")}function nm(l,o){return l.filter(function(s){return!mn(s,o)})}var $r=1,Pa=1,Lm=0,_e=0,Ht=0,li="";function Wr(l,o,s,c,f,p,x,S){return{value:l,root:o,parent:s,type:c,props:f,children:p,line:$r,column:Pa,length:x,return:"",siblings:S}}function Gn(l,o){return Ns(Wr("",null,null,"",null,null,0,l.siblings),l,{length:-l.length},o)}function Wa(l){for(;l.root;)l=Gn(l.root,{children:[l]});ol(l,l.siblings)}function px(){return Ht}function gx(){return Ht=_e>0?Jt(li,--_e):0,Pa--,Ht===10&&(Pa=1,$r--),Ht}function He(){return Ht=_e<Lm?Jt(li,_e++):0,Pa++,Ht===10&&(Pa=1,$r++),Ht}function sa(){return Jt(li,_e)}function Br(){return _e}function Fr(l,o){return Ia(li,l,o)}function Ts(l){switch(l){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function xx(l){return $r=Pa=1,Lm=Ve(li=l),_e=0,[]}function vx(l){return li="",l}function Ss(l){return qm(Fr(_e-1,Cs(l===91?l+2:l===40?l+1:l)))}function bx(l){for(;(Ht=sa())&&Ht<33;)He();return Ts(l)>2||Ts(Ht)>3?"":" "}function yx(l,o){for(;--o&&He()&&!(Ht<48||Ht>102||Ht>57&&Ht<65||Ht>70&&Ht<97););return Fr(l,Br()+(o<6&&sa()==32&&He()==32))}function Cs(l){for(;He();)switch(Ht){case l:return _e;case 34:case 39:l!==34&&l!==39&&Cs(Ht);break;case 40:l===41&&Cs(l);break;case 92:He();break}return _e}function wx(l,o){for(;He()&&l+Ht!==57;)if(l+Ht===84&&sa()===47)break;return"/*"+Fr(o,_e-1)+"*"+Qs(l===47?l:He())}function Sx(l){for(;!Ts(sa());)He();return Fr(l,_e)}function zx(l){return vx(Ur("",null,null,null,[""],l=xx(l),0,[0],l))}function Ur(l,o,s,c,f,p,x,S,g){for(var h=0,b=0,T=x,M=0,k=0,H=0,q=1,X=1,U=1,Z=0,Y="",F=f,V=p,I=c,J=Y;X;)switch(H=Z,Z=He()){case 40:if(H!=108&&Jt(J,T-1)==58){_r(J+=lt(Ss(Z),"&","&\f"),"&\f",Hm(h?S[h-1]:0))!=-1&&(U=-1);break}case 34:case 39:case 91:J+=Ss(Z);break;case 9:case 10:case 13:case 32:J+=bx(H);break;case 92:J+=yx(Br()-1,7);continue;case 47:switch(sa()){case 42:case 47:ol(Ax(wx(He(),Br()),o,s,g),g);break;default:J+="/"}break;case 123*q:S[h++]=Ve(J)*U;case 125*q:case 59:case 0:switch(Z){case 0:case 125:X=0;case 59+b:U==-1&&(J=lt(J,/\f/g,"")),k>0&&Ve(J)-T&&ol(k>32?im(J+";",c,s,T-1,g):im(lt(J," ","")+";",c,s,T-2,g),g);break;case 59:J+=";";default:if(ol(I=am(J,o,s,h,b,f,S,Y,F=[],V=[],T,p),p),Z===123)if(b===0)Ur(J,o,I,I,F,p,T,S,V);else switch(M===99&&Jt(J,3)===110?100:M){case 100:case 108:case 109:case 115:Ur(l,I,I,c&&ol(am(l,I,I,0,0,f,S,Y,f,F=[],T,V),V),f,V,T,S,c?F:V);break;default:Ur(J,I,I,I,[""],V,0,S,V)}}h=b=k=0,q=U=1,Y=J="",T=x;break;case 58:T=1+Ve(J),k=H;default:if(q<1){if(Z==123)--q;else if(Z==125&&q++==0&&gx()==125)continue}switch(J+=Qs(Z),Z*q){case 38:U=b>0?1:(J+="\f",-1);break;case 44:S[h++]=(Ve(J)-1)*U,U=1;break;case 64:sa()===45&&(J+=Ss(He())),M=sa(),b=T=Ve(Y=J+=Sx(Br())),Z++;break;case 45:H===45&&Ve(J)==2&&(q=0)}}return p}function am(l,o,s,c,f,p,x,S,g,h,b,T){for(var M=f-1,k=f===0?p:[""],H=Ym(k),q=0,X=0,U=0;q<c;++q)for(var Z=0,Y=Ia(l,M+1,M=Hm(X=x[q])),F=l;Z<H;++Z)(F=qm(X>0?k[Z]+" "+Y:lt(Y,/&\f/g,k[Z])))&&(g[U++]=F);return Wr(l,o,s,f===0?Jr:S,g,h,b,T)}function Ax(l,o,s,c){return Wr(l,o,s,Um,Qs(px()),Ia(l,2,-2),0,c)}function im(l,o,s,c,f){return Wr(l,o,s,Gs,Ia(l,0,c),Ia(l,c+1,-1),c,f)}function Gm(l,o,s){switch(hx(l,o)){case 5103:return xt+"print-"+l+l;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return xt+l+l;case 4789:return cl+l+l;case 5349:case 4246:case 4810:case 6968:case 2756:return xt+l+cl+l+Rt+l+l;case 5936:switch(Jt(l,o+11)){case 114:return xt+l+Rt+lt(l,/[svh]\w+-[tblr]{2}/,"tb")+l;case 108:return xt+l+Rt+lt(l,/[svh]\w+-[tblr]{2}/,"tb-rl")+l;case 45:return xt+l+Rt+lt(l,/[svh]\w+-[tblr]{2}/,"lr")+l}case 6828:case 4268:case 2903:return xt+l+Rt+l+l;case 6165:return xt+l+Rt+"flex-"+l+l;case 5187:return xt+l+lt(l,/(\w+).+(:[^]+)/,xt+"box-$1$2"+Rt+"flex-$1$2")+l;case 5443:return xt+l+Rt+"flex-item-"+lt(l,/flex-|-self/g,"")+(mn(l,/flex-|baseline/)?"":Rt+"grid-row-"+lt(l,/flex-|-self/g,""))+l;case 4675:return xt+l+Rt+"flex-line-pack"+lt(l,/align-content|flex-|-self/g,"")+l;case 5548:return xt+l+Rt+lt(l,"shrink","negative")+l;case 5292:return xt+l+Rt+lt(l,"basis","preferred-size")+l;case 6060:return xt+"box-"+lt(l,"-grow","")+xt+l+Rt+lt(l,"grow","positive")+l;case 4554:return xt+lt(l,/([^-])(transform)/g,"$1"+xt+"$2")+l;case 6187:return lt(lt(lt(l,/(zoom-|grab)/,xt+"$1"),/(image-set)/,xt+"$1"),l,"")+l;case 5495:case 3959:return lt(l,/(image-set\([^]*)/,xt+"$1$`$1");case 4968:return lt(lt(l,/(.+:)(flex-)?(.*)/,xt+"box-pack:$3"+Rt+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+xt+l+l;case 4200:if(!mn(l,/flex-|baseline/))return Rt+"grid-column-align"+Ia(l,o)+l;break;case 2592:case 3360:return Rt+lt(l,"template-","")+l;case 4384:case 3616:return s&&s.some(function(c,f){return o=f,mn(c.props,/grid-\w+-end/)})?~_r(l+(s=s[o].value),"span",0)?l:Rt+lt(l,"-start","")+l+Rt+"grid-row-span:"+(~_r(s,"span",0)?mn(s,/\d+/):+mn(s,/\d+/)-+mn(l,/\d+/))+";":Rt+lt(l,"-start","")+l;case 4896:case 4128:return s&&s.some(function(c){return mn(c.props,/grid-\w+-start/)})?l:Rt+lt(lt(l,"-end","-span"),"span ","")+l;case 4095:case 3583:case 4068:case 2532:return lt(l,/(.+)-inline(.+)/,xt+"$1$2")+l;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(Ve(l)-1-o>6)switch(Jt(l,o+1)){case 109:if(Jt(l,o+4)!==45)break;case 102:return lt(l,/(.+:)(.+)-([^]+)/,"$1"+xt+"$2-$3$1"+cl+(Jt(l,o+3)==108?"$3":"$2-$3"))+l;case 115:return~_r(l,"stretch",0)?Gm(lt(l,"stretch","fill-available"),o,s)+l:l}break;case 5152:case 5920:return lt(l,/(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/,function(c,f,p,x,S,g,h){return Rt+f+":"+p+h+(x?Rt+f+"-span:"+(S?g:+g-+p)+h:"")+l});case 4949:if(Jt(l,o+6)===121)return lt(l,":",":"+xt)+l;break;case 6444:switch(Jt(l,Jt(l,14)===45?18:11)){case 120:return lt(l,/(.+:)([^;\s!]+)(;|(\s+)?!.+)?/,"$1"+xt+(Jt(l,14)===45?"inline-":"")+"box$3$1"+xt+"$2$3$1"+Rt+"$2box$3")+l;case 100:return lt(l,":",":"+Rt)+l}break;case 5719:case 2647:case 2135:case 3927:case 2391:return lt(l,"scroll-","scroll-snap-")+l}return l}function Lr(l,o){for(var s="",c=0;c<l.length;c++)s+=o(l[c],c,l,o)||"";return s}function Ex(l,o,s,c){switch(l.type){case dx:if(l.children.length)break;case fx:case Gs:return l.return=l.return||l.value;case Um:return"";case km:return l.return=l.value+"{"+Lr(l.children,c)+"}";case Jr:if(!Ve(l.value=l.props.join(",")))return""}return Ve(s=Lr(l.children,c))?l.return=l.value+"{"+s+"}":""}function jx(l){var o=Ym(l);return function(s,c,f,p){for(var x="",S=0;S<o;S++)x+=l[S](s,c,f,p)||"";return x}}function Rx(l){return function(o){o.root||(o=o.return)&&l(o)}}function Nx(l,o,s,c){if(l.length>-1&&!l.return)switch(l.type){case Gs:l.return=Gm(l.value,l.length,s);return;case km:return Lr([Gn(l,{value:lt(l.value,"@","@"+xt)})],c);case Jr:if(l.length)return mx(s=l.props,function(f){switch(mn(f,c=/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":Wa(Gn(l,{props:[lt(f,/:(read-\w+)/,":"+cl+"$1")]})),Wa(Gn(l,{props:[f]})),Ns(l,{props:nm(s,c)});break;case"::placeholder":Wa(Gn(l,{props:[lt(f,/:(plac\w+)/,":"+xt+"input-$1")]})),Wa(Gn(l,{props:[lt(f,/:(plac\w+)/,":"+cl+"$1")]})),Wa(Gn(l,{props:[lt(f,/:(plac\w+)/,Rt+"input-$1")]})),Wa(Gn(l,{props:[f]})),Ns(l,{props:nm(s,c)});break}return""})}}var Tx={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},ye={},ti=typeof process<"u"&&ye!==void 0&&(ye.REACT_APP_SC_ATTR||ye.SC_ATTR)||"data-styled",Qm="active",Xm="data-styled-version",Ir="6.1.19",Xs=`/*!sc*/
`,Gr=typeof window<"u"&&typeof document<"u",Cx=!!(typeof SC_DISABLE_SPEEDY=="boolean"?SC_DISABLE_SPEEDY:typeof process<"u"&&ye!==void 0&&ye.REACT_APP_SC_DISABLE_SPEEDY!==void 0&&ye.REACT_APP_SC_DISABLE_SPEEDY!==""?ye.REACT_APP_SC_DISABLE_SPEEDY!=="false"&&ye.REACT_APP_SC_DISABLE_SPEEDY:typeof process<"u"&&ye!==void 0&&ye.SC_DISABLE_SPEEDY!==void 0&&ye.SC_DISABLE_SPEEDY!==""&&ye.SC_DISABLE_SPEEDY!=="false"&&ye.SC_DISABLE_SPEEDY),Pr=Object.freeze([]),ei=Object.freeze({});function Dx(l,o,s){return s===void 0&&(s=ei),l.theme!==s.theme&&l.theme||o||s.theme}var Vm=new Set(["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","track","u","ul","use","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"]),Ox=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,Mx=/(^-|-$)/g;function lm(l){return l.replace(Ox,"-").replace(Mx,"")}var _x=/(a)(d)/gi,Cr=52,rm=function(l){return String.fromCharCode(l+(l>25?39:97))};function Ds(l){var o,s="";for(o=Math.abs(l);o>Cr;o=o/Cr|0)s=rm(o%Cr)+s;return(rm(o%Cr)+s).replace(_x,"$1-$2")}var zs,Zm=5381,Fa=function(l,o){for(var s=o.length;s;)l=33*l^o.charCodeAt(--s);return l},Km=function(l){return Fa(Zm,l)};function Bx(l){return Ds(Km(l)>>>0)}function Ux(l){return l.displayName||l.name||"Component"}function As(l){return typeof l=="string"&&!0}var Jm=typeof Symbol=="function"&&Symbol.for,$m=Jm?Symbol.for("react.memo"):60115,kx=Jm?Symbol.for("react.forward_ref"):60112,Hx={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},qx={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},Wm={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},Yx=((zs={})[kx]={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},zs[$m]=Wm,zs);function om(l){return("type"in(o=l)&&o.type.$$typeof)===$m?Wm:"$$typeof"in l?Yx[l.$$typeof]:Hx;var o}var Lx=Object.defineProperty,Gx=Object.getOwnPropertyNames,cm=Object.getOwnPropertySymbols,Qx=Object.getOwnPropertyDescriptor,Xx=Object.getPrototypeOf,sm=Object.prototype;function Fm(l,o,s){if(typeof o!="string"){if(sm){var c=Xx(o);c&&c!==sm&&Fm(l,c,s)}var f=Gx(o);cm&&(f=f.concat(cm(o)));for(var p=om(l),x=om(o),S=0;S<f.length;++S){var g=f[S];if(!(g in qx||s&&s[g]||x&&g in x||p&&g in p)){var h=Qx(o,g);try{Lx(l,g,h)}catch{}}}}return l}function ni(l){return typeof l=="function"}function Vs(l){return typeof l=="object"&&"styledComponentId"in l}function ca(l,o){return l&&o?"".concat(l," ").concat(o):l||o||""}function um(l,o){if(l.length===0)return"";for(var s=l[0],c=1;c<l.length;c++)s+=l[c];return s}function ul(l){return l!==null&&typeof l=="object"&&l.constructor.name===Object.name&&!("props"in l&&l.$$typeof)}function Os(l,o,s){if(s===void 0&&(s=!1),!s&&!ul(l)&&!Array.isArray(l))return o;if(Array.isArray(o))for(var c=0;c<o.length;c++)l[c]=Os(l[c],o[c]);else if(ul(o))for(var c in o)l[c]=Os(l[c],o[c]);return l}function Zs(l,o){Object.defineProperty(l,"toString",{value:o})}function ml(l){for(var o=[],s=1;s<arguments.length;s++)o[s-1]=arguments[s];return new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(l," for more information.").concat(o.length>0?" Args: ".concat(o.join(", ")):""))}var Vx=(function(){function l(o){this.groupSizes=new Uint32Array(512),this.length=512,this.tag=o}return l.prototype.indexOfGroup=function(o){for(var s=0,c=0;c<o;c++)s+=this.groupSizes[c];return s},l.prototype.insertRules=function(o,s){if(o>=this.groupSizes.length){for(var c=this.groupSizes,f=c.length,p=f;o>=p;)if((p<<=1)<0)throw ml(16,"".concat(o));this.groupSizes=new Uint32Array(p),this.groupSizes.set(c),this.length=p;for(var x=f;x<p;x++)this.groupSizes[x]=0}for(var S=this.indexOfGroup(o+1),g=(x=0,s.length);x<g;x++)this.tag.insertRule(S,s[x])&&(this.groupSizes[o]++,S++)},l.prototype.clearGroup=function(o){if(o<this.length){var s=this.groupSizes[o],c=this.indexOfGroup(o),f=c+s;this.groupSizes[o]=0;for(var p=c;p<f;p++)this.tag.deleteRule(c)}},l.prototype.getGroup=function(o){var s="";if(o>=this.length||this.groupSizes[o]===0)return s;for(var c=this.groupSizes[o],f=this.indexOfGroup(o),p=f+c,x=f;x<p;x++)s+="".concat(this.tag.getRule(x)).concat(Xs);return s},l})(),kr=new Map,Qr=new Map,Hr=1,Dr=function(l){if(kr.has(l))return kr.get(l);for(;Qr.has(Hr);)Hr++;var o=Hr++;return kr.set(l,o),Qr.set(o,l),o},Zx=function(l,o){Hr=o+1,kr.set(l,o),Qr.set(o,l)},Kx="style[".concat(ti,"][").concat(Xm,'="').concat(Ir,'"]'),Jx=new RegExp("^".concat(ti,'\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')),$x=function(l,o,s){for(var c,f=s.split(","),p=0,x=f.length;p<x;p++)(c=f[p])&&l.registerName(o,c)},Wx=function(l,o){for(var s,c=((s=o.textContent)!==null&&s!==void 0?s:"").split(Xs),f=[],p=0,x=c.length;p<x;p++){var S=c[p].trim();if(S){var g=S.match(Jx);if(g){var h=0|parseInt(g[1],10),b=g[2];h!==0&&(Zx(b,h),$x(l,b,g[3]),l.getTag().insertRules(h,f)),f.length=0}else f.push(S)}}},fm=function(l){for(var o=document.querySelectorAll(Kx),s=0,c=o.length;s<c;s++){var f=o[s];f&&f.getAttribute(ti)!==Qm&&(Wx(l,f),f.parentNode&&f.parentNode.removeChild(f))}};function Fx(){return typeof __webpack_nonce__<"u"?__webpack_nonce__:null}var Im=function(l){var o=document.head,s=l||o,c=document.createElement("style"),f=(function(S){var g=Array.from(S.querySelectorAll("style[".concat(ti,"]")));return g[g.length-1]})(s),p=f!==void 0?f.nextSibling:null;c.setAttribute(ti,Qm),c.setAttribute(Xm,Ir);var x=Fx();return x&&c.setAttribute("nonce",x),s.insertBefore(c,p),c},Ix=(function(){function l(o){this.element=Im(o),this.element.appendChild(document.createTextNode("")),this.sheet=(function(s){if(s.sheet)return s.sheet;for(var c=document.styleSheets,f=0,p=c.length;f<p;f++){var x=c[f];if(x.ownerNode===s)return x}throw ml(17)})(this.element),this.length=0}return l.prototype.insertRule=function(o,s){try{return this.sheet.insertRule(s,o),this.length++,!0}catch{return!1}},l.prototype.deleteRule=function(o){this.sheet.deleteRule(o),this.length--},l.prototype.getRule=function(o){var s=this.sheet.cssRules[o];return s&&s.cssText?s.cssText:""},l})(),Px=(function(){function l(o){this.element=Im(o),this.nodes=this.element.childNodes,this.length=0}return l.prototype.insertRule=function(o,s){if(o<=this.length&&o>=0){var c=document.createTextNode(s);return this.element.insertBefore(c,this.nodes[o]||null),this.length++,!0}return!1},l.prototype.deleteRule=function(o){this.element.removeChild(this.nodes[o]),this.length--},l.prototype.getRule=function(o){return o<this.length?this.nodes[o].textContent:""},l})(),tv=(function(){function l(o){this.rules=[],this.length=0}return l.prototype.insertRule=function(o,s){return o<=this.length&&(this.rules.splice(o,0,s),this.length++,!0)},l.prototype.deleteRule=function(o){this.rules.splice(o,1),this.length--},l.prototype.getRule=function(o){return o<this.length?this.rules[o]:""},l})(),dm=Gr,ev={isServer:!Gr,useCSSOMInjection:!Cx},Pm=(function(){function l(o,s,c){o===void 0&&(o=ei),s===void 0&&(s={});var f=this;this.options=ue(ue({},ev),o),this.gs=s,this.names=new Map(c),this.server=!!o.isServer,!this.server&&Gr&&dm&&(dm=!1,fm(this)),Zs(this,function(){return(function(p){for(var x=p.getTag(),S=x.length,g="",h=function(T){var M=(function(U){return Qr.get(U)})(T);if(M===void 0)return"continue";var k=p.names.get(M),H=x.getGroup(T);if(k===void 0||!k.size||H.length===0)return"continue";var q="".concat(ti,".g").concat(T,'[id="').concat(M,'"]'),X="";k!==void 0&&k.forEach(function(U){U.length>0&&(X+="".concat(U,","))}),g+="".concat(H).concat(q,'{content:"').concat(X,'"}').concat(Xs)},b=0;b<S;b++)h(b);return g})(f)})}return l.registerId=function(o){return Dr(o)},l.prototype.rehydrate=function(){!this.server&&Gr&&fm(this)},l.prototype.reconstructWithOptions=function(o,s){return s===void 0&&(s=!0),new l(ue(ue({},this.options),o),this.gs,s&&this.names||void 0)},l.prototype.allocateGSInstance=function(o){return this.gs[o]=(this.gs[o]||0)+1},l.prototype.getTag=function(){return this.tag||(this.tag=(o=(function(s){var c=s.useCSSOMInjection,f=s.target;return s.isServer?new tv(f):c?new Ix(f):new Px(f)})(this.options),new Vx(o)));var o},l.prototype.hasNameForId=function(o,s){return this.names.has(o)&&this.names.get(o).has(s)},l.prototype.registerName=function(o,s){if(Dr(o),this.names.has(o))this.names.get(o).add(s);else{var c=new Set;c.add(s),this.names.set(o,c)}},l.prototype.insertRules=function(o,s,c){this.registerName(o,s),this.getTag().insertRules(Dr(o),c)},l.prototype.clearNames=function(o){this.names.has(o)&&this.names.get(o).clear()},l.prototype.clearRules=function(o){this.getTag().clearGroup(Dr(o)),this.clearNames(o)},l.prototype.clearTag=function(){this.tag=void 0},l})(),nv=/&/g,av=/^\s*\/\/.*$/gm;function tp(l,o){return l.map(function(s){return s.type==="rule"&&(s.value="".concat(o," ").concat(s.value),s.value=s.value.replaceAll(",",",".concat(o," ")),s.props=s.props.map(function(c){return"".concat(o," ").concat(c)})),Array.isArray(s.children)&&s.type!=="@keyframes"&&(s.children=tp(s.children,o)),s})}function iv(l){var o,s,c,f=ei,p=f.options,x=p===void 0?ei:p,S=f.plugins,g=S===void 0?Pr:S,h=function(M,k,H){return H.startsWith(s)&&H.endsWith(s)&&H.replaceAll(s,"").length>0?".".concat(o):M},b=g.slice();b.push(function(M){M.type===Jr&&M.value.includes("&")&&(M.props[0]=M.props[0].replace(nv,s).replace(c,h))}),x.prefix&&b.push(Nx),b.push(Ex);var T=function(M,k,H,q){k===void 0&&(k=""),H===void 0&&(H=""),q===void 0&&(q="&"),o=q,s=k,c=new RegExp("\\".concat(s,"\\b"),"g");var X=M.replace(av,""),U=zx(H||k?"".concat(H," ").concat(k," { ").concat(X," }"):X);x.namespace&&(U=tp(U,x.namespace));var Z=[];return Lr(U,jx(b.concat(Rx(function(Y){return Z.push(Y)})))),Z};return T.hash=g.length?g.reduce(function(M,k){return k.name||ml(15),Fa(M,k.name)},Zm).toString():"",T}var lv=new Pm,Ms=iv(),ep=Me.createContext({shouldForwardProp:void 0,styleSheet:lv,stylis:Ms});ep.Consumer;Me.createContext(void 0);function hm(){return A.useContext(ep)}var rv=(function(){function l(o,s){var c=this;this.inject=function(f,p){p===void 0&&(p=Ms);var x=c.name+p.hash;f.hasNameForId(c.id,x)||f.insertRules(c.id,x,p(c.rules,x,"@keyframes"))},this.name=o,this.id="sc-keyframes-".concat(o),this.rules=s,Zs(this,function(){throw ml(12,String(c.name))})}return l.prototype.getName=function(o){return o===void 0&&(o=Ms),this.name+o.hash},l})(),ov=function(l){return l>="A"&&l<="Z"};function mm(l){for(var o="",s=0;s<l.length;s++){var c=l[s];if(s===1&&c==="-"&&l[0]==="-")return l;ov(c)?o+="-"+c.toLowerCase():o+=c}return o.startsWith("ms-")?"-"+o:o}var np=function(l){return l==null||l===!1||l===""},ap=function(l){var o,s,c=[];for(var f in l){var p=l[f];l.hasOwnProperty(f)&&!np(p)&&(Array.isArray(p)&&p.isCss||ni(p)?c.push("".concat(mm(f),":"),p,";"):ul(p)?c.push.apply(c,Yr(Yr(["".concat(f," {")],ap(p),!1),["}"],!1)):c.push("".concat(mm(f),": ").concat((o=f,(s=p)==null||typeof s=="boolean"||s===""?"":typeof s!="number"||s===0||o in Tx||o.startsWith("--")?String(s).trim():"".concat(s,"px")),";")))}return c};function ua(l,o,s,c){if(np(l))return[];if(Vs(l))return[".".concat(l.styledComponentId)];if(ni(l)){if(!ni(p=l)||p.prototype&&p.prototype.isReactComponent||!o)return[l];var f=l(o);return ua(f,o,s,c)}var p;return l instanceof rv?s?(l.inject(s,c),[l.getName(c)]):[l]:ul(l)?ap(l):Array.isArray(l)?Array.prototype.concat.apply(Pr,l.map(function(x){return ua(x,o,s,c)})):[l.toString()]}function cv(l){for(var o=0;o<l.length;o+=1){var s=l[o];if(ni(s)&&!Vs(s))return!1}return!0}var sv=Km(Ir),uv=(function(){function l(o,s,c){this.rules=o,this.staticRulesId="",this.isStatic=(c===void 0||c.isStatic)&&cv(o),this.componentId=s,this.baseHash=Fa(sv,s),this.baseStyle=c,Pm.registerId(s)}return l.prototype.generateAndInjectStyles=function(o,s,c){var f=this.baseStyle?this.baseStyle.generateAndInjectStyles(o,s,c):"";if(this.isStatic&&!c.hash)if(this.staticRulesId&&s.hasNameForId(this.componentId,this.staticRulesId))f=ca(f,this.staticRulesId);else{var p=um(ua(this.rules,o,s,c)),x=Ds(Fa(this.baseHash,p)>>>0);if(!s.hasNameForId(this.componentId,x)){var S=c(p,".".concat(x),void 0,this.componentId);s.insertRules(this.componentId,x,S)}f=ca(f,x),this.staticRulesId=x}else{for(var g=Fa(this.baseHash,c.hash),h="",b=0;b<this.rules.length;b++){var T=this.rules[b];if(typeof T=="string")h+=T;else if(T){var M=um(ua(T,o,s,c));g=Fa(g,M+b),h+=M}}if(h){var k=Ds(g>>>0);s.hasNameForId(this.componentId,k)||s.insertRules(this.componentId,k,c(h,".".concat(k),void 0,this.componentId)),f=ca(f,k)}}return f},l})(),ip=Me.createContext(void 0);ip.Consumer;var Es={};function fv(l,o,s){var c=Vs(l),f=l,p=!As(l),x=o.attrs,S=x===void 0?Pr:x,g=o.componentId,h=g===void 0?(function(F,V){var I=typeof F!="string"?"sc":lm(F);Es[I]=(Es[I]||0)+1;var J="".concat(I,"-").concat(Bx(Ir+I+Es[I]));return V?"".concat(V,"-").concat(J):J})(o.displayName,o.parentComponentId):g,b=o.displayName,T=b===void 0?(function(F){return As(F)?"styled.".concat(F):"Styled(".concat(Ux(F),")")})(l):b,M=o.displayName&&o.componentId?"".concat(lm(o.displayName),"-").concat(o.componentId):o.componentId||h,k=c&&f.attrs?f.attrs.concat(S).filter(Boolean):S,H=o.shouldForwardProp;if(c&&f.shouldForwardProp){var q=f.shouldForwardProp;if(o.shouldForwardProp){var X=o.shouldForwardProp;H=function(F,V){return q(F,V)&&X(F,V)}}else H=q}var U=new uv(s,M,c?f.componentStyle:void 0);function Z(F,V){return(function(I,J,wt){var vt=I.attrs,ne=I.componentStyle,ie=I.defaultProps,Lt=I.foldedComponentIds,$e=I.styledComponentId,We=I.target,Gt=Me.useContext(ip),C=hm(),G=I.shouldForwardProp||C.shouldForwardProp,P=Dx(J,Gt,ie)||ei,ct=(function(st,et,Qt){for(var gt,It=ue(ue({},et),{className:void 0,theme:Qt}),Qn=0;Qn<st.length;Qn+=1){var Fe=ni(gt=st[Qn])?gt(It):gt;for(var ze in Fe)It[ze]=ze==="className"?ca(It[ze],Fe[ze]):ze==="style"?ue(ue({},It[ze]),Fe[ze]):Fe[ze]}return et.className&&(It.className=ca(It.className,et.className)),It})(vt,J,P),y=ct.as||We,B={};for(var L in ct)ct[L]===void 0||L[0]==="$"||L==="as"||L==="theme"&&ct.theme===P||(L==="forwardedAs"?B.as=ct.forwardedAs:G&&!G(L,y)||(B[L]=ct[L]));var Q=(function(st,et){var Qt=hm(),gt=st.generateAndInjectStyles(et,Qt.styleSheet,Qt.stylis);return gt})(ne,ct),W=ca(Lt,$e);return Q&&(W+=" "+Q),ct.className&&(W+=" "+ct.className),B[As(y)&&!Vm.has(y)?"class":"className"]=W,wt&&(B.ref=wt),A.createElement(y,B)})(Y,F,V)}Z.displayName=T;var Y=Me.forwardRef(Z);return Y.attrs=k,Y.componentStyle=U,Y.displayName=T,Y.shouldForwardProp=H,Y.foldedComponentIds=c?ca(f.foldedComponentIds,f.styledComponentId):"",Y.styledComponentId=M,Y.target=c?f.target:l,Object.defineProperty(Y,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(F){this._foldedDefaultProps=c?(function(V){for(var I=[],J=1;J<arguments.length;J++)I[J-1]=arguments[J];for(var wt=0,vt=I;wt<vt.length;wt++)Os(V,vt[wt],!0);return V})({},f.defaultProps,F):F}}),Zs(Y,function(){return".".concat(Y.styledComponentId)}),p&&Fm(Y,l,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),Y}function pm(l,o){for(var s=[l[0]],c=0,f=o.length;c<f;c+=1)s.push(o[c],l[c+1]);return s}var gm=function(l){return Object.assign(l,{isCss:!0})};function dv(l){for(var o=[],s=1;s<arguments.length;s++)o[s-1]=arguments[s];if(ni(l)||ul(l))return gm(ua(pm(Pr,Yr([l],o,!0))));var c=l;return o.length===0&&c.length===1&&typeof c[0]=="string"?ua(c):gm(ua(pm(c,o)))}function _s(l,o,s){if(s===void 0&&(s=ei),!o)throw ml(1,o);var c=function(f){for(var p=[],x=1;x<arguments.length;x++)p[x-1]=arguments[x];return l(o,s,dv.apply(void 0,Yr([f],p,!1)))};return c.attrs=function(f){return _s(l,o,ue(ue({},s),{attrs:Array.prototype.concat(s.attrs,f).filter(Boolean)}))},c.withConfig=function(f){return _s(l,o,ue(ue({},s),f))},c}var lp=function(l){return _s(fv,l)},pt=lp;Vm.forEach(function(l){pt[l]=lp(l)});const hv=pt.div`
  width: 100%;
  min-height: 100vh;
  margin-top: 10px;
...
`,Ks="/Movies-ReactJS/assets/Logonetflix-cJzkA86F.png";function gv(){const l=Bt(),o=()=>{l("/sign-in")};return d.jsxs(pv,{children:[d.jsx("img",{src:Ks,alt:"Logo da Netflix"}),d.jsxs("div",{className:"user-controls",children:[d.jsxs("select",{children:[d.jsx("option",{value:"portugues",children:"Português"}),d.jsx("option",{value:"ingles",children:"Inglês"})]}),d.jsx("button",{onClick:o,children:"Entrar"})]})]})}const xv="/Movies-ReactJS/assets/background-G0Np5zM9.jpg",vv=pt.div`
...
`,Cv="/Movies-ReactJS/assets/kids-DbAjh5sn.png";function Dv(){return d.jsx(Tv,{children:d.jsxs("div",{className:"content-section",children:[d.jsxs("div",{className:"text",children:[d.jsx("h2",{children:"Crie perfis para crianças"}),d.jsx("p",{children:"Deixe as crianças se aventurarem com seus personagens favoritos em um espaço feito só para elas, sem pagar a mais por isso."})]}),d.jsx("img",{src:Cv,alt:"Mobile"})]})})}const Ov=pt.div`
  width: 100%;
  height: 80vh;
  background-color: black;
  color: white;
...
`,Mv="/Movies-ReactJS/assets/movel-A3IsfRxB.png";function _v(){return d.jsx(Ov,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("img",{src:Mv,alt:"Mobile"}),d.jsxs("div",{className:"text",children:[d.jsx("h2",{children:"Baixe séries para assistir offline"}),d.jsx("p",{children:"Assista em um avião, trem ou submarino..."})]})]})})}const Bv=pt.div`
  width: 100%;
  min-height: 100vh; 
  color: white;
  margin-top: 10px;
...
`;function Lv(){const o=xn().state?.email||"",[s,c]=A.useState(o||""),[f,p]=A.useState(""),x=Bt(),S=()=>{x("/")},g=()=>{if(!s.trim()||!f.trim()){alert("Preencha todos os campos!");return}x("/main-app")};return d.jsx(d.Fragment,{children:d.jsxs(Yv,{children:[d.jsx(qv,{}),d.jsx("div",{className:"container",children:d.jsxs("div",{className:"content-section",children:[d.jsx("h2",{children:"Entrar"}),d.jsx("input",{type:"text",placeholder:"E-mail ou número de celular",value:s,onChange:h=>c(h.target.value),name:"new-email",autoComplete:"new-email"}),d.jsx("input",{type:"password",placeholder:"Senha",value:f,onChange:h=>p(h.target.value),name:"new-password",autoComplete:"new-password"}),d.jsx("button",{onClick:g,children:"Entrar"}),d.jsx("p",{className:"separate",children:"OU"}),d.jsxs("div",{className:"forgot-password",children:[d.jsx("p",{children:"Use um código de login"}),d.jsx("a",{href:"#",children:"Esqueceu sua senha?"})]}),d.jsxs("div",{className:"remember",children:[d.jsx("input",{type:"checkbox"}),d.jsx("label",{children:"Lembra de Mim?"})]}),d.jsxs("div",{className:"sign-up-now",children:[d.jsx("p",{children:"Novo na Netflix"}),d.jsx("p",{onClick:S,children:d.jsx("strong",{children:"Assine Já"})})]})]})})]})})}const Gv=pt.div`
...
`;function Zv(){const l=Bt(),o=()=>l("/"),[s,c]=A.useState(!1),f=()=>c(!s),p=S=>{const g=document.getElementById(S);g&&g.scrollIntoView({behavior:"smooth"})},x=()=>{l("/")};return d.jsxs(Vv,{id:"inicio",children:[d.jsxs("div",{className:"content-section",children:[d.jsxs("div",{className:"p1",children:[d.jsx("img",{src:Ks,alt:"Logo Netflix"}),d.jsxs("div",{className:"desktop-menu",children:[d.jsx("p",{onClick:()=>p("inicio"),children:"Início"}),d.jsx("p",{onClick:()=>p("series"),children:"Séries"}),d.jsx("p",{onClick:()=>p("filmes"),children:"Filmes"}),d.jsx("p",{onClick:()=>p("populares"),children:"Novos & Populares"}),d.jsx("p",{onClick:()=>p("sagas"),children:"Top Sagas"})]})]}),d.jsxs("div",{className:"p2",children:[d.jsx("button",{onClick:o,children:"Sair"}),d.jsx("div",{className:"btn-mobile",onClick:f,children:d.jsx("p",{children:"☰"})})]})]}),d.jsxs("div",{className:`side-menu ${s?"open":""}`,children:[d.jsx("div",{className:"close-btn",onClick:f,children:"×"}),d.jsx("p",{onClick:()=>p("inicio"),children:"Início"}),d.jsx("p",{onClick:()=>p("series"),children:"Séries"}),d.jsx("p",{onClick:()=>p("filmes"),children:"Filmes"}),d.jsx("p",{onClick:()=>p("populares"),children:"Novos & Populares"}),d.jsx("p",{onClick:()=>p("sagas"),children:"Top Sagas"}),d.jsx("button",{className:"exit",onClick:x,children:"Sair"})]}),s&&d.jsx("div",{className:"overlay",onClick:f})]})}const Kv=pt.div`
  position: relative;
  width: 100%;
  height: 48vh;
...
`;function Jv(){const[l,o]=A.useState(""),[s,c]=A.useState(""),[f,p]=A.useState(),[x,S]=A.useState(""),[g,h]=A.useState(""),[b,T]=A.useState(""),M=Bt(),k=(H,q)=>{M(`/details/${H}`,{state:{type:q}})};return A.useEffect(()=>{(async()=>{const q="ee96350ded551df8af41839e03615c58";try{const U=await(await fetch(`https://api.themoviedb.org/3/tv/66732?api_key=${q}&language=pt-BR`)).json();o(U.name),p(U.number_of_seasons),c(U.overview);const Y=await(await fetch(`https://api.themoviedb.org/3/tv/66732/images?api_key=${q}`)).json(),F=Y.posters[30],V=Y.backdrops[4],I=Y.backdrops[30];S("https://image.tmdb.org/t/p/original/olAK0DWZmTpqRTRyNpqFUxKGbw6.jpg"),T("https://image.tmdb.org/t/p/original/hTWtybOC91veCgHAVt3ULZnj4up.jpg"),h(`https://image.tmdb.org/t/p/original${I.file_path}`)}catch(X){console.error("Erro ao buscar banner:",X)}})()},[]),d.jsx(Kv,{bg:x,bg2:b,bg3:g,children:d.jsxs("div",{className:"content-section",children:[d.jsx("div",{className:"title",children:d.jsx("h1",{children:l.toUpperCase()})}),d.jsxs("div",{className:"desc",children:[d.jsxs("p",{className:"season",children:["Assista a temporada ",f]}),d.jsxs("p",{children:[s.slice(0,85),"..."]}),d.jsxs("div",{className:"btn",children:[d.jsx("a",{href:"https://youtu.be/iKZyYdwS3Wg?si=_PmLTcQVMn-G5chD",target:"_blank",children:d.jsx("button",{className:"play",children:" ▶ Assistir"})}),d.jsx("button",{onClick:()=>k(66732,"tv"),className:"more",children:"Mais Informações"})]})]})]})})}const $v=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function lb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${s}&with_networks=213&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=h=>{c(`/details/${h}`,{state:{type:"tv"}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(ib,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{className:"saga-title",children:d.jsx("strong",{children:"Originais Netflix"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const rb=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function ob(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=h=>{c(`/details/${h}`)},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(rb,{id:"filmes",children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{className:"saga-title",children:d.jsx("strong",{children:"Em Alta"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const cb=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function sb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/movie?with_genres=35&api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=h=>{c(`/details/${h}`)},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(cb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{className:"saga-title",children:d.jsx("strong",{children:"Comédia"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const ub=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function fb(){const[l,o]=A.useState([]),s=Bt(),c=A.useRef(null),f="ee96350ded551df8af41839e03615c58",p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/movie?with_genres=27&api_key=${f}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=h=>{s(`/details/${h}`)},S=()=>{c.current&&c.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{c.current&&c.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(ub,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{className:"saga-title",children:d.jsx("strong",{children:"Terror"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:c,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const db=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function hb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=h=>{c(`/details/${h}`,{state:{type:"tv"}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(db,{id:"series",children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{className:"saga-title",children:d.jsx("strong",{children:"Séries de TV"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.name||h.title})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const mb=pt.div`
  width: 100%;
  background-color: black;
  color: white;
  padding-bottom: 0px;
...
`;function pb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?query=star%20wars&api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(mb,{id:"sagas",children:d.jsxs("div",{className:"content-section",children:[d.jsx("h2",{className:"main-title",children:"Sagas Populares"}),d.jsx("p",{className:"saga-title",children:d.jsx("strong",{children:"Universo Star Wars"})}),d.jsxs("div",{className:"saga-block carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const gb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function xb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=Indiana%20Jones`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(gb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo Indiana Jones"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const vb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function bb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=Jurassic%20Park`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(vb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo Jurassic Park"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const yb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function wb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=Harry%20Potter`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(yb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo Harry Potter"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const Sb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function zb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=The%20Lord%20Of%20Rings`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(Sb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo Senhor dos Anéis"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const Ab=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function Eb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${s}&language=pt-BR&with_companies=420`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const x=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},g=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(Ab,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo Marvel"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>x(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:g,children:d.jsx(Se,{})})]})]})})}const jb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function Rb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=[268,49026,297802,297761,272,141052,297762,474395,155,209112,464052,1042305],f=Bt(),p=A.useRef(null),x=async()=>{try{const b=c.map(M=>fetch(`https://api.themoviedb.org/3/movie/${M}?api_key=${s}&language=pt-BR`).then(k=>k.json())),T=await Promise.all(b);o(T.filter(M=>M.poster_path))}catch(b){console.error("Erro ao buscar filmes DC:",b)}};A.useEffect(()=>{x()},[]);const S=(b,T)=>{f(`/details/${b}`,{state:{type:T}})},g=()=>{p.current&&p.current.scrollBy({left:-500,behavior:"smooth"})},h=()=>{p.current&&p.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(jb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo DC"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:g,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:p,children:l.map(b=>d.jsx("div",{className:"card",onClick:()=>S(b.id,b.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${b.poster_path}`,alt:b.title||b.name})},b.id))}),d.jsx("button",{className:"arrow right",onClick:h,children:d.jsx(Se,{})})]})]})})}const Nb=pt.div`
  max-height: 700px;
  width: 100%;
  background-color: black;
  color: white;
