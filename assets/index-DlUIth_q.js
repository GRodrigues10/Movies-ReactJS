...
`,Dv="/Movies-ReactJS/assets/kids-DbAjh5sn.png";function Cv(){return d.jsx(Tv,{children:d.jsxs("div",{className:"content-section",children:[d.jsxs("div",{className:"text",children:[d.jsx("h2",{children:"Crie perfis para crianças"}),d.jsx("p",{children:"Deixe as crianças se aventurarem com seus personagens favoritos em um espaço feito só para elas, sem pagar a mais por isso."})]}),d.jsx("img",{src:Dv,alt:"Mobile"})]})})}const Ov=pt.div`
  width: 100%;
  height: 80vh;
  background-color: black;
  color: white;
...
`;function ob(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=h=>{c(`/details/${h}`)},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(rb,{id:"filmes",children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{className:"saga-title",children:d.jsx("strong",{children:"Em Alta"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>g(h.id),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),d.jsx("button",{className:"arrow right",onClick:x,children:d.jsx(Se,{})})]})]})})}const cb=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function xb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=Indiana%20Jones`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(gb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo Indiana Jones"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:x,children:d.jsx(Se,{})})]})]})})}const vb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function zb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Bt(),f=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=The%20Lord%20Of%20Rings`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{f.current&&f.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{f.current&&f.current.scrollBy({left:500,behavior:"smooth"})};return d.jsx(Sb,{children:d.jsxs("div",{className:"content-section",children:[d.jsx("p",{children:d.jsx("strong",{children:"Universo Senhor dos Anéis"})}),d.jsxs("div",{className:"carousel-container",children:[d.jsx("button",{className:"arrow left",onClick:S,children:d.jsx(we,{})}),d.jsx("div",{className:"cards",ref:f,children:l.filter(h=>h.poster_path).map(h=>d.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:d.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),d.jsx("button",{className:"arrow right",onClick:x,children:d.jsx(Se,{})})]})]})})}const Ab=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
