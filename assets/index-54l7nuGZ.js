 ...
 */var Lh;function Cg(){if(Lh)return al;Lh=1;var l=Symbol.for("react.transitional.element"),o=Symbol.for("react.fragment");function s(c,d,p){var g=null;if(p!==void 0&&(g=""+p),d.key!==void 0&&(g=""+d.key),"key"in d){p={};for(var S in d)S!=="key"&&(p[S]=d[S])}else p=d;return d=p.ref,{$$typeof:l,type:c,key:g,ref:d!==void 0?d:null,props:p}}return al.Fragment=o,al.jsx=s,al.jsxs=s,al}var Gh;function Mg(){return Gh||(Gh=1,ms.exports=Cg()),ms.exports}var f=Mg(),ps={exports:{}},it={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 *
 * @license MIT
 */var Fh="popstate";function Gg(l={}){function o(c,d){let{pathname:p,search:g,hash:S}=c.location;return js("",{pathname:p,search:g,hash:S},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function s(c,d){return typeof d=="string"?d:sl(d)}return Xg(o,s,null,l)}function Dt(l,o){if(l===!1||l===null||typeof l>"u")throw new Error(o)}function Ze(l,o){if(!l){typeof console<"u"&&console.warn(o);try{throw new Error(o)}catch{}}}function Qg(){return Math.random().toString(36).substring(2,10)}function Ih(l,o){return{usr:l.state,key:l.key,idx:o}}function js(l,o,s=null,c){return{pathname:typeof l=="string"?l:l.pathname,search:"",hash:"",...typeof o=="string"?ai(o):o,state:s,key:o&&o.key||c||Qg()}}function sl({pathname:l="/",search:o="",hash:s=""}){return o&&o!=="?"&&(l+=o.charAt(0)==="?"?o:"?"+o),s&&s!=="#"&&(l+=s.charAt(0)==="#"?s:"#"+s),l}function ai(l){let o={};if(l){let s=l.indexOf("#");s>=0&&(o.hash=l.substring(s),l=l.substring(0,s));let c=l.indexOf("?");c>=0&&(o.search=l.substring(c),l=l.substring(0,c)),l&&(o.pathname=l)}return o}function Xg(l,o,s,c={}){let{window:d=document.defaultView,v5Compat:p=!1}=c,g=d.history,S="POP",x=null,h=b();h==null&&(h=0,g.replaceState({...g.state,idx:h},""));function b(){return(g.state||{idx:null}).idx}function T(){S="POP";let X=b(),U=X==null?null:X-h;h=X,x&&x({action:S,location:q.location,delta:U})}function M(X,U){S="PUSH";let Z=js(q.location,X,U);h=b()+1;let Y=Ih(Z,h),F=q.createHref(Z);try{g.pushState(Y,"",F)}catch(V){if(V instanceof DOMException&&V.name==="DataCloneError")throw V;d.location.assign(F)}p&&x&&x({action:S,location:q.location,delta:1})}function k(X,U){S="REPLACE";let Z=js(q.location,X,U);h=b();let Y=Ih(Z,h),F=q.createHref(Z);g.replaceState(Y,"",F),p&&x&&x({action:S,location:q.location,delta:0})}function H(X){return Vg(X)}let q={get action(){return S},get location(){return l(d,g)},listen(X){if(x)throw new Error("A history only accepts one active listener");return d.addEventListener(Fh,T),x=X,()=>{d.removeEventListener(Fh,T),x=null}},createHref(X){return o(d,X)},createURL:H,encodeLocation(X){let U=H(X);return{pathname:U.pathname,search:U.search,hash:U.hash}},push:M,replace:k,go(X){return g.go(X)}};return q}function Vg(l,o=!1){let s="http://localhost";typeof window<"u"&&(s=window.location.origin!=="null"?window.location.origin:window.location.href),Dt(s,"No window.location.(origin|href) available to create URL");let c=typeof l=="string"?l:sl(l);return c=c.replace(/ $/,"%20"),!o&&c.startsWith("//")&&(c=s+c),new URL(c,s)}function ym(l,o,s="/"){return Zg(l,o,s,!1)}function Zg(l,o,s,c){let d=typeof o=="string"?ai(o):o,p=gn(d.pathname||"/",s);if(p==null)return null;let g=wm(l);Kg(g);let S=null;for(let x=0;S==null&&x<g.length;++x){let h=i1(p);S=n1(g[x],h,c)}return S}function wm(l,o=[],s=[],c="",d=!1){let p=(g,S,x=d,h)=>{let b={relativePath:h===void 0?g.path||"":h,caseSensitive:g.caseSensitive===!0,childrenIndex:S,route:g};if(b.relativePath.startsWith("/")){if(!b.relativePath.startsWith(c)&&x)return;Dt(b.relativePath.startsWith(c),`Absolute route path "${b.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),b.relativePath=b.relativePath.slice(c.length)}let T=pn([c,b.relativePath]),M=s.concat(b);g.children&&g.children.length>0&&(Dt(g.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${T}".`),wm(g.children,o,M,T,x)),!(g.path==null&&!g.index)&&o.push({path:T,score:t1(T,g.index),routesMeta:M})};return l.forEach((g,S)=>{if(g.path===""||!g.path?.includes("?"))p(g,S);else for(let x of Sm(g.path))p(g,S,!0,x)}),o}function Sm(l){let o=l.split("/");if(o.length===0)return[];let[s,...c]=o,d=s.endsWith("?"),p=s.replace(/\?$/,"");if(c.length===0)return d?[p,""]:[p];let g=Sm(c.join("/")),S=[];return S.push(...g.map(x=>x===""?p:[p,x].join("/"))),d&&S.push(...g),S.map(x=>l.startsWith("/")&&x===""?"/":x)}function Kg(l){l.sort((o,s)=>o.score!==s.score?s.score-o.score:e1(o.routesMeta.map(c=>c.childrenIndex),s.routesMeta.map(c=>c.childrenIndex)))}var Jg=/^:[\w-]+$/,$g=3,Wg=2,Fg=1,Ig=10,Pg=-2,Ph=l=>l==="*";function t1(l,o){let s=l.split("/"),c=s.length;return s.some(Ph)&&(c+=Pg),o&&(c+=Wg),s.filter(d=>!Ph(d)).reduce((d,p)=>d+(Jg.test(p)?$g:p===""?Fg:Ig),c)}function e1(l,o){return l.length===o.length&&l.slice(0,-1).every((c,d)=>c===o[d])?l[l.length-1]-o[o.length-1]:0}function n1(l,o,s=!1){let{routesMeta:c}=l,d={},p="/",g=[];for(let S=0;S<c.length;++S){let x=c[S],h=S===c.length-1,b=p==="/"?o:o.slice(p.length)||"/",T=qr({path:x.relativePath,caseSensitive:x.caseSensitive,end:h},b),M=x.route;if(!T&&h&&s&&!c[c.length-1].route.index&&(T=qr({path:x.relativePath,caseSensitive:x.caseSensitive,end:!1},b)),!T)return null;Object.assign(d,T.params),g.push({params:d,pathname:pn([p,T.pathname]),pathnameBase:c1(pn([p,T.pathnameBase])),route:M}),T.pathnameBase!=="/"&&(p=pn([p,T.pathnameBase]))}return g}function qr(l,o){typeof l=="string"&&(l={path:l,caseSensitive:!1,end:!0});let[s,c]=a1(l.path,l.caseSensitive,l.end),d=o.match(s);if(!d)return null;let p=d[0],g=p.replace(/(.)\/+$/,"$1"),S=d.slice(1);return{params:c.reduce((h,{paramName:b,isOptional:T},M)=>{if(b==="*"){let H=S[M]||"";g=p.slice(0,p.length-H.length).replace(/(.)\/+$/,"$1")}const k=S[M];return T&&!k?h[b]=void 0:h[b]=(k||"").replace(/%2F/g,"/"),h},{}),pathname:p,pathnameBase:g,pattern:l}}function a1(l,o=!1,s=!0){Ze(l==="*"||!l.endsWith("*")||l.endsWith("/*"),`Route path "${l}" will be treated as if it were "${l.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${l.replace(/\*$/,"/*")}".`);let c=[],d="^"+l.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(g,S,x)=>(c.push({paramName:S,isOptional:x!=null}),x?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return l.endsWith("*")?(c.push({paramName:"*"}),d+=l==="*"||l==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):s?d+="\\/*$":l!==""&&l!=="/"&&(d+="(?:(?=\\/|$))"),[new RegExp(d,o?void 0:"i"),c]}function i1(l){try{return l.split("/").map(o=>decodeURIComponent(o).replace(/\//g,"%2F")).join("/")}catch(o){return Ze(!1,`The URL path "${l}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${o}).`),l}}function gn(l,o){if(o==="/")return l;if(!l.toLowerCase().startsWith(o.toLowerCase()))return null;let s=o.endsWith("/")?o.length-1:o.length,c=l.charAt(s);return c&&c!=="/"?null:l.slice(s)||"/"}function l1(l,o="/"){let{pathname:s,search:c="",hash:d=""}=typeof l=="string"?ai(l):l;return{pathname:s?s.startsWith("/")?s:r1(s,o):o,search:s1(c),hash:u1(d)}}function r1(l,o){let s=o.replace(/\/+$/,"").split("/");return l.split("/").forEach(d=>{d===".."?s.length>1&&s.pop():d!=="."&&s.push(d)}),s.length>1?s.join("/"):"/"}function ys(l,o,s,c){return`Cannot include a '${l}' character in a manually specified \`to.${o}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${s}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function o1(l){return l.filter((o,s)=>s===0||o.route.path&&o.route.path.length>0)}function zm(l){let o=o1(l);return o.map((s,c)=>c===o.length-1?s.pathname:s.pathnameBase)}function Am(l,o,s,c=!1){let d;typeof l=="string"?d=ai(l):(d={...l},Dt(!d.pathname||!d.pathname.includes("?"),ys("?","pathname","search",d)),Dt(!d.pathname||!d.pathname.includes("#"),ys("#","pathname","hash",d)),Dt(!d.search||!d.search.includes("#"),ys("#","search","hash",d)));let p=l===""||d.pathname==="",g=p?"/":d.pathname,S;if(g==null)S=s;else{let T=o.length-1;if(!c&&g.startsWith("..")){let M=g.split("/");for(;M[0]==="..";)M.shift(),T-=1;d.pathname=M.join("/")}S=T>=0?o[T]:"/"}let x=l1(d,S),h=g&&g!=="/"&&g.endsWith("/"),b=(p||g===".")&&s.endsWith("/");return!x.pathname.endsWith("/")&&(h||b)&&(x.pathname+="/"),x}var pn=l=>l.join("/").replace(/\/\/+/g,"/"),c1=l=>l.replace(/\/+$/,"").replace(/^\/*/,"/"),s1=l=>!l||l==="?"?"":l.startsWith("?")?l:"?"+l,u1=l=>!l||l==="#"?"":l.startsWith("#")?l:"#"+l;function f1(l){return l!=null&&typeof l.status=="number"&&typeof l.statusText=="string"&&typeof l.internal=="boolean"&&"data"in l}var Em=["POST","PUT","PATCH","DELETE"];new Set(Em);var d1=["GET",...Em];new Set(d1);var ii=A.createContext(null);ii.displayName="DataRouter";var Zr=A.createContext(null);Zr.displayName="DataRouterState";A.createContext(!1);var jm=A.createContext({isTransitioning:!1});jm.displayName="ViewTransition";var h1=A.createContext(new Map);h1.displayName="Fetchers";var m1=A.createContext(null);m1.displayName="Await";var Ke=A.createContext(null);Ke.displayName="Navigation";var fl=A.createContext(null);fl.displayName="Location";var Je=A.createContext({outlet:null,matches:[],isDataRoute:!1});Je.displayName="Route";var Us=A.createContext(null);Us.displayName="RouteError";function p1(l,{relative:o}={}){Dt(dl(),"useHref() may be used only in the context of a <Router> component.");let{basename:s,navigator:c}=A.useContext(Ke),{hash:d,pathname:p,search:g}=hl(l,{relative:o}),S=p;return s!=="/"&&(S=p==="/"?s:pn([s,p])),c.createHref({pathname:S,search:g,hash:d})}function dl(){return A.useContext(fl)!=null}function Gn(){return Dt(dl(),"useLocation() may be used only in the context of a <Router> component."),A.useContext(fl).location}var Rm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Nm(l){A.useContext(Ke).static||A.useLayoutEffect(l)}function Yt(){let{isDataRoute:l}=A.useContext(Je);return l?T1():g1()}function g1(){Dt(dl(),"useNavigate() may be used only in the context of a <Router> component.");let l=A.useContext(ii),{basename:o,navigator:s}=A.useContext(Ke),{matches:c}=A.useContext(Je),{pathname:d}=Gn(),p=JSON.stringify(zm(c)),g=A.useRef(!1);return Nm(()=>{g.current=!0}),A.useCallback((x,h={})=>{if(Ze(g.current,Rm),!g.current)return;if(typeof x=="number"){s.go(x);return}let b=Am(x,JSON.parse(p),d,h.relative==="path");l==null&&o!=="/"&&(b.pathname=b.pathname==="/"?o:pn([o,b.pathname])),(h.replace?s.replace:s.push)(b,h.state,h)},[o,s,p,d,l])}A.createContext(null);function x1(){let{matches:l}=A.useContext(Je),o=l[l.length-1];return o?o.params:{}}function hl(l,{relative:o}={}){let{matches:s}=A.useContext(Je),{pathname:c}=Gn(),d=JSON.stringify(zm(s));return A.useMemo(()=>Am(l,JSON.parse(d),c,o==="path"),[l,d,c,o])}function v1(l,o){return Tm(l,o)}function Tm(l,o,s,c){Dt(dl(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d}=A.useContext(Ke),{matches:p}=A.useContext(Je),g=p[p.length-1],S=g?g.params:{},x=g?g.pathname:"/",h=g?g.pathnameBase:"/",b=g&&g.route;{let U=b&&b.path||"";Dm(x,!b||U.endsWith("*")||U.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${x}" (under <Route path="${U}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let T=Gn(),M;if(o){let U=typeof o=="string"?ai(o):o;Dt(h==="/"||U.pathname?.startsWith(h),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${h}" but pathname "${U.pathname}" was given in the \`location\` prop.`),M=U}else M=T;let k=M.pathname||"/",H=k;if(h!=="/"){let U=h.replace(/^\//,"").split("/");H="/"+k.replace(/^\//,"").split("/").slice(U.length).join("/")}let q=ym(l,{pathname:H});Ze(b||q!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),Ze(q==null||q[q.length-1].route.element!==void 0||q[q.length-1].route.Component!==void 0||q[q.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let X=z1(q&&q.map(U=>Object.assign({},U,{params:Object.assign({},S,U.params),pathname:pn([h,d.encodeLocation?d.encodeLocation(U.pathname).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?h:pn([h,d.encodeLocation?d.encodeLocation(U.pathnameBase).pathname:U.pathnameBase])})),p,s,c);return o&&X?A.createElement(fl.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},X):X}function b1(){let l=N1(),o=f1(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),s=l instanceof Error?l.stack:null,c="rgba(200,200,200, 0.5)",d={padding:"0.5rem",backgroundColor:c},p={padding:"2px 4px",backgroundColor:c},g=null;return console.error("Error handled by React Router default ErrorBoundary:",l),g=A.createElement(A.Fragment,null,A.createElement("p",null,"💿 Hey developer 👋"),A.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",A.createElement("code",{style:p},"ErrorBoundary")," or"," ",A.createElement("code",{style:p},"errorElement")," prop on your route.")),A.createElement(A.Fragment,null,A.createElement("h2",null,"Unexpected Application Error!"),A.createElement("h3",{style:{fontStyle:"italic"}},o),s?A.createElement("pre",{style:d},s):null,g)}var y1=A.createElement(b1,null),w1=class extends A.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,o){return o.location!==l.location||o.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:o.error,location:o.location,revalidation:l.revalidation||o.revalidation}}componentDidCatch(l,o){console.error("React Router caught the following error during render",l,o)}render(){return this.state.error!==void 0?A.createElement(Je.Provider,{value:this.props.routeContext},A.createElement(Us.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function S1({routeContext:l,match:o,children:s}){let c=A.useContext(ii);return c&&c.static&&c.staticContext&&(o.route.errorElement||o.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=o.route.id),A.createElement(Je.Provider,{value:l},s)}function z1(l,o=[],s=null,c=null){if(l==null){if(!s)return null;if(s.errors)l=s.matches;else if(o.length===0&&!s.initialized&&s.matches.length>0)l=s.matches;else return null}let d=l,p=s?.errors;if(p!=null){let x=d.findIndex(h=>h.route.id&&p?.[h.route.id]!==void 0);Dt(x>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),d=d.slice(0,Math.min(d.length,x+1))}let g=!1,S=-1;if(s)for(let x=0;x<d.length;x++){let h=d[x];if((h.route.HydrateFallback||h.route.hydrateFallbackElement)&&(S=x),h.route.id){let{loaderData:b,errors:T}=s,M=h.route.loader&&!b.hasOwnProperty(h.route.id)&&(!T||T[h.route.id]===void 0);if(h.route.lazy||M){g=!0,S>=0?d=d.slice(0,S+1):d=[d[0]];break}}}return d.reduceRight((x,h,b)=>{let T,M=!1,k=null,H=null;s&&(T=p&&h.route.id?p[h.route.id]:void 0,k=h.route.errorElement||y1,g&&(S<0&&b===0?(Dm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),M=!0,H=null):S===b&&(M=!0,H=h.route.hydrateFallbackElement||null)));let q=o.concat(d.slice(0,b+1)),X=()=>{let U;return T?U=k:M?U=H:h.route.Component?U=A.createElement(h.route.Component,null):h.route.element?U=h.route.element:U=x,A.createElement(S1,{match:h,routeContext:{outlet:x,matches:q,isDataRoute:s!=null},children:U})};return s&&(h.route.ErrorBoundary||h.route.errorElement||b===0)?A.createElement(w1,{location:s.location,revalidation:s.revalidation,component:k,error:T,children:X(),routeContext:{outlet:null,matches:q,isDataRoute:!0}}):X()},null)}function ks(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function A1(l){let o=A.useContext(ii);return Dt(o,ks(l)),o}function E1(l){let o=A.useContext(Zr);return Dt(o,ks(l)),o}function j1(l){let o=A.useContext(Je);return Dt(o,ks(l)),o}function Hs(l){let o=j1(l),s=o.matches[o.matches.length-1];return Dt(s.route.id,`${l} can only be used on routes that contain a unique "id"`),s.route.id}function R1(){return Hs("useRouteId")}function N1(){let l=A.useContext(Us),o=E1("useRouteError"),s=Hs("useRouteError");return l!==void 0?l:o.errors?.[s]}function T1(){let{router:l}=A1("useNavigate"),o=Hs("useNavigate"),s=A.useRef(!1);return Nm(()=>{s.current=!0}),A.useCallback(async(d,p={})=>{Ze(s.current,Rm),s.current&&(typeof d=="number"?l.navigate(d):await l.navigate(d,{fromRouteId:o,...p}))},[l,o])}var tm={};function Dm(l,o,s){!o&&!tm[l]&&(tm[l]=!0,Ze(!1,s))}A.memo(D1);function D1({routes:l,future:o,state:s}){return Tm(l,void 0,s,o)}function rl(l){Dt(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function O1({basename:l="/",children:o=null,location:s,navigationType:c="POP",navigator:d,static:p=!1}){Dt(!dl(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let g=l.replace(/^\/*/,"/"),S=A.useMemo(()=>({basename:g,navigator:d,static:p,future:{}}),[g,d,p]);typeof s=="string"&&(s=ai(s));let{pathname:x="/",search:h="",hash:b="",state:T=null,key:M="default"}=s,k=A.useMemo(()=>{let H=gn(x,g);return H==null?null:{location:{pathname:H,search:h,hash:b,state:T,key:M},navigationType:c}},[g,x,h,b,T,M,c]);return Ze(k!=null,`<Router basename="${g}"> is not able to match the URL "${x}${h}${b}" because it does not start with the basename, so the <Router> won't render anything.`),k==null?null:A.createElement(Ke.Provider,{value:S},A.createElement(fl.Provider,{children:o,value:k}))}function C1({children:l,location:o}){return v1(Rs(l),o)}function Rs(l,o=[]){let s=[];return A.Children.forEach(l,(c,d)=>{if(!A.isValidElement(c))return;let p=[...o,d];if(c.type===A.Fragment){s.push.apply(s,Rs(c.props.children,p));return}Dt(c.type===rl,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Dt(!c.props.index||!c.props.children,"An index route cannot have child routes.");let g={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(g.children=Rs(c.props.children,p)),s.push(g)}),s}var Cr="get",Mr="application/x-www-form-urlencoded";function Kr(l){return l!=null&&typeof l.tagName=="string"}function M1(l){return Kr(l)&&l.tagName.toLowerCase()==="button"}function _1(l){return Kr(l)&&l.tagName.toLowerCase()==="form"}function B1(l){return Kr(l)&&l.tagName.toLowerCase()==="input"}function U1(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function k1(l,o){return l.button===0&&(!o||o==="_self")&&!U1(l)}var Tr=null;function H1(){if(Tr===null)try{new FormData(document.createElement("form"),0),Tr=!1}catch{Tr=!0}return Tr}var q1=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function ws(l){return l!=null&&!q1.has(l)?(Ze(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Mr}"`),null):l}function Y1(l,o){let s,c,d,p,g;if(_1(l)){let S=l.getAttribute("action");c=S?gn(S,o):null,s=l.getAttribute("method")||Cr,d=ws(l.getAttribute("enctype"))||Mr,p=new FormData(l)}else if(M1(l)||B1(l)&&(l.type==="submit"||l.type==="image")){let S=l.form;if(S==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let x=l.getAttribute("formaction")||S.getAttribute("action");if(c=x?gn(x,o):null,s=l.getAttribute("formmethod")||S.getAttribute("method")||Cr,d=ws(l.getAttribute("formenctype"))||ws(S.getAttribute("enctype"))||Mr,p=new FormData(S,l),!H1()){let{name:h,type:b,value:T}=l;if(b==="image"){let M=h?`${h}.`:"";p.append(`${M}x`,"0"),p.append(`${M}y`,"0")}else h&&p.append(h,T)}}else{if(Kr(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');s=Cr,c=null,d=Mr,g=l}return p&&d==="text/plain"&&(g=p,p=void 0),{action:c,method:s.toLowerCase(),encType:d,formData:p,body:g}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function qs(l,o){if(l===!1||l===null||typeof l>"u")throw new Error(o)}function L1(l,o,s){let c=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return c.pathname==="/"?c.pathname=`_root.${s}`:o&&gn(c.pathname,o)==="/"?c.pathname=`${o.replace(/\/$/,"")}/_root.${s}`:c.pathname=`${c.pathname.replace(/\/$/,"")}.${s}`,c}async function G1(l,o){if(l.id in o)return o[l.id];try{let s=await import(l.module);return o[l.id]=s,s}catch(s){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(s),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Q1(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function X1(l,o,s){let c=await Promise.all(l.map(async d=>{let p=o.routes[d.route.id];if(p){let g=await G1(p,s);return g.links?g.links():[]}return[]}));return J1(c.flat(1).filter(Q1).filter(d=>d.rel==="stylesheet"||d.rel==="preload").map(d=>d.rel==="stylesheet"?{...d,rel:"prefetch",as:"style"}:{...d,rel:"prefetch"}))}function em(l,o,s,c,d,p){let g=(x,h)=>s[h]?x.route.id!==s[h].route.id:!0,S=(x,h)=>s[h].pathname!==x.pathname||s[h].route.path?.endsWith("*")&&s[h].params["*"]!==x.params["*"];return p==="assets"?o.filter((x,h)=>g(x,h)||S(x,h)):p==="data"?o.filter((x,h)=>{let b=c.routes[x.route.id];if(!b||!b.hasLoader)return!1;if(g(x,h)||S(x,h))return!0;if(x.route.shouldRevalidate){let T=x.route.shouldRevalidate({currentUrl:new URL(d.pathname+d.search+d.hash,window.origin),currentParams:s[0]?.params||{},nextUrl:new URL(l,window.origin),nextParams:x.params,defaultShouldRevalidate:!0});if(typeof T=="boolean")return T}return!0}):[]}function V1(l,o,{includeHydrateFallback:s}={}){return Z1(l.map(c=>{let d=o.routes[c.route.id];if(!d)return[];let p=[d.module];return d.clientActionModule&&(p=p.concat(d.clientActionModule)),d.clientLoaderModule&&(p=p.concat(d.clientLoaderModule)),s&&d.hydrateFallbackModule&&(p=p.concat(d.hydrateFallbackModule)),d.imports&&(p=p.concat(d.imports)),p}).flat(1))}function Z1(l){return[...new Set(l)]}function K1(l){let o={},s=Object.keys(l).sort();for(let c of s)o[c]=l[c];return o}function J1(l,o){let s=new Set;return new Set(o),l.reduce((c,d)=>{let p=JSON.stringify(K1(d));return s.has(p)||(s.add(p),c.push({key:p,link:d})),c},[])}function Om(){let l=A.useContext(ii);return qs(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function $1(){let l=A.useContext(Zr);return qs(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var Ys=A.createContext(void 0);Ys.displayName="FrameworkContext";function Cm(){let l=A.useContext(Ys);return qs(l,"You must render this element inside a <HydratedRouter> element"),l}function W1(l,o){let s=A.useContext(Ys),[c,d]=A.useState(!1),[p,g]=A.useState(!1),{onFocus:S,onBlur:x,onMouseEnter:h,onMouseLeave:b,onTouchStart:T}=o,M=A.useRef(null);A.useEffect(()=>{if(l==="render"&&g(!0),l==="viewport"){let q=U=>{U.forEach(Z=>{g(Z.isIntersecting)})},X=new IntersectionObserver(q,{threshold:.5});return M.current&&X.observe(M.current),()=>{X.disconnect()}}},[l]),A.useEffect(()=>{if(c){let q=setTimeout(()=>{g(!0)},100);return()=>{clearTimeout(q)}}},[c]);let k=()=>{d(!0)},H=()=>{d(!1),g(!1)};return s?l!=="intent"?[p,M,{}]:[p,M,{onFocus:ll(S,k),onBlur:ll(x,H),onMouseEnter:ll(h,k),onMouseLeave:ll(b,H),onTouchStart:ll(T,k)}]:[!1,M,{}]}function ll(l,o){return s=>{l&&l(s),s.defaultPrevented||o(s)}}function F1({page:l,...o}){let{router:s}=Om(),c=A.useMemo(()=>ym(s.routes,l,s.basename),[s.routes,l,s.basename]);return c?A.createElement(P1,{page:l,matches:c,...o}):null}function I1(l){let{manifest:o,routeModules:s}=Cm(),[c,d]=A.useState([]);return A.useEffect(()=>{let p=!1;return X1(l,o,s).then(g=>{p||d(g)}),()=>{p=!0}},[l,o,s]),c}function P1({page:l,matches:o,...s}){let c=Gn(),{manifest:d,routeModules:p}=Cm(),{basename:g}=Om(),{loaderData:S,matches:x}=$1(),h=A.useMemo(()=>em(l,o,x,d,c,"data"),[l,o,x,d,c]),b=A.useMemo(()=>em(l,o,x,d,c,"assets"),[l,o,x,d,c]),T=A.useMemo(()=>{if(l===c.pathname+c.search+c.hash)return[];let H=new Set,q=!1;if(o.forEach(U=>{let Z=d.routes[U.route.id];!Z||!Z.hasLoader||(!h.some(Y=>Y.route.id===U.route.id)&&U.route.id in S&&p[U.route.id]?.shouldRevalidate||Z.hasClientLoader?q=!0:H.add(U.route.id))}),H.size===0)return[];let X=L1(l,g,"data");return q&&H.size>0&&X.searchParams.set("_routes",o.filter(U=>H.has(U.route.id)).map(U=>U.route.id).join(",")),[X.pathname+X.search]},[g,S,c,d,h,o,l,p]),M=A.useMemo(()=>V1(b,d),[b,d]),k=I1(b);return A.createElement(A.Fragment,null,T.map(H=>A.createElement("link",{key:H,rel:"prefetch",as:"fetch",href:H,...s})),M.map(H=>A.createElement("link",{key:H,rel:"modulepreload",href:H,...s})),k.map(({key:H,link:q})=>A.createElement("link",{key:H,nonce:s.nonce,...q})))}function tx(...l){return o=>{l.forEach(s=>{typeof s=="function"?s(o):s!=null&&(s.current=o)})}}var Mm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Mm&&(window.__reactRouterVersion="7.8.1")}catch{}function ex({basename:l,children:o,window:s}){let c=A.useRef();c.current==null&&(c.current=Gg({window:s,v5Compat:!0}));let d=c.current,[p,g]=A.useState({action:d.action,location:d.location}),S=A.useCallback(x=>{A.startTransition(()=>g(x))},[g]);return A.useLayoutEffect(()=>d.listen(S),[d,S]),A.createElement(O1,{basename:l,children:o,location:p.location,navigationType:p.action,navigator:d})}var _m=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ls=A.forwardRef(function({onClick:o,discover:s="render",prefetch:c="none",relative:d,reloadDocument:p,replace:g,state:S,target:x,to:h,preventScrollReset:b,viewTransition:T,...M},k){let{basename:H}=A.useContext(Ke),q=typeof h=="string"&&_m.test(h),X,U=!1;if(typeof h=="string"&&q&&(X=h,Mm))try{let vt=new URL(window.location.href),ne=h.startsWith("//")?new URL(vt.protocol+h):new URL(h),ie=gn(ne.pathname,H);ne.origin===vt.origin&&ie!=null?h=ie+ne.search+ne.hash:U=!0}catch{Ze(!1,`<Link to="${h}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let Z=p1(h,{relative:d}),[Y,F,V]=W1(c,M),I=lx(h,{replace:g,state:S,target:x,preventScrollReset:b,relative:d,viewTransition:T});function J(vt){o&&o(vt),vt.defaultPrevented||I(vt)}let wt=A.createElement("a",{...M,...V,href:X||Z,onClick:U||p?o:J,ref:tx(k,F),target:x,"data-discover":!q&&s==="render"?"true":void 0});return Y&&!q?A.createElement(A.Fragment,null,wt,A.createElement(F1,{page:Z})):wt});Ls.displayName="Link";var nx=A.forwardRef(function({"aria-current":o="page",caseSensitive:s=!1,className:c="",end:d=!1,style:p,to:g,viewTransition:S,children:x,...h},b){let T=hl(g,{relative:h.relative}),M=Gn(),k=A.useContext(Zr),{navigator:H,basename:q}=A.useContext(Ke),X=k!=null&&ux(T)&&S===!0,U=H.encodeLocation?H.encodeLocation(T).pathname:T.pathname,Z=M.pathname,Y=k&&k.navigation&&k.navigation.location?k.navigation.location.pathname:null;s||(Z=Z.toLowerCase(),Y=Y?Y.toLowerCase():null,U=U.toLowerCase()),Y&&q&&(Y=gn(Y,q)||Y);const F=U!=="/"&&U.endsWith("/")?U.length-1:U.length;let V=Z===U||!d&&Z.startsWith(U)&&Z.charAt(F)==="/",I=Y!=null&&(Y===U||!d&&Y.startsWith(U)&&Y.charAt(U.length)==="/"),J={isActive:V,isPending:I,isTransitioning:X},wt=V?o:void 0,vt;typeof c=="function"?vt=c(J):vt=[c,V?"active":null,I?"pending":null,X?"transitioning":null].filter(Boolean).join(" ");let ne=typeof p=="function"?p(J):p;return A.createElement(Ls,{...h,"aria-current":wt,className:vt,ref:b,style:ne,to:g,viewTransition:S},typeof x=="function"?x(J):x)});nx.displayName="NavLink";var ax=A.forwardRef(({discover:l="render",fetcherKey:o,navigate:s,reloadDocument:c,replace:d,state:p,method:g=Cr,action:S,onSubmit:x,relative:h,preventScrollReset:b,viewTransition:T,...M},k)=>{let H=cx(),q=sx(S,{relative:h}),X=g.toLowerCase()==="get"?"get":"post",U=typeof S=="string"&&_m.test(S),Z=Y=>{if(x&&x(Y),Y.defaultPrevented)return;Y.preventDefault();let F=Y.nativeEvent.submitter,V=F?.getAttribute("formmethod")||g;H(F||Y.currentTarget,{fetcherKey:o,method:V,navigate:s,replace:d,state:p,relative:h,preventScrollReset:b,viewTransition:T})};return A.createElement("form",{ref:k,method:X,action:q,onSubmit:c?x:Z,...M,"data-discover":!U&&l==="render"?"true":void 0})});ax.displayName="Form";function ix(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Bm(l){let o=A.useContext(ii);return Dt(o,ix(l)),o}function lx(l,{target:o,replace:s,state:c,preventScrollReset:d,relative:p,viewTransition:g}={}){let S=Yt(),x=Gn(),h=hl(l,{relative:p});return A.useCallback(b=>{if(k1(b,o)){b.preventDefault();let T=s!==void 0?s:sl(x)===sl(h);S(l,{replace:T,state:c,preventScrollReset:d,relative:p,viewTransition:g})}},[x,S,h,s,c,o,l,d,p,g])}var rx=0,ox=()=>`__${String(++rx)}__`;function cx(){let{router:l}=Bm("useSubmit"),{basename:o}=A.useContext(Ke),s=R1();return A.useCallback(async(c,d={})=>{let{action:p,method:g,encType:S,formData:x,body:h}=Y1(c,o);if(d.navigate===!1){let b=d.fetcherKey||ox();await l.fetch(b,s,d.action||p,{preventScrollReset:d.preventScrollReset,formData:x,body:h,formMethod:d.method||g,formEncType:d.encType||S,flushSync:d.flushSync})}else await l.navigate(d.action||p,{preventScrollReset:d.preventScrollReset,formData:x,body:h,formMethod:d.method||g,formEncType:d.encType||S,replace:d.replace,state:d.state,fromRouteId:s,flushSync:d.flushSync,viewTransition:d.viewTransition})},[l,o,s])}function sx(l,{relative:o}={}){let{basename:s}=A.useContext(Ke),c=A.useContext(Je);Dt(c,"useFormAction must be used inside a RouteContext");let[d]=c.matches.slice(-1),p={...hl(l||".",{relative:o})},g=Gn();if(l==null){p.search=g.search;let S=new URLSearchParams(p.search),x=S.getAll("index");if(x.some(b=>b==="")){S.delete("index"),x.filter(T=>T).forEach(T=>S.append("index",T));let b=S.toString();p.search=b?`?${b}`:""}}return(!l||l===".")&&d.route.index&&(p.search=p.search?p.search.replace(/^\?/,"?index&"):"?index"),s!=="/"&&(p.pathname=p.pathname==="/"?s:pn([s,p.pathname])),sl(p)}function ux(l,{relative:o}={}){let s=A.useContext(jm);Dt(s!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=Bm("useViewTransitionState"),d=hl(l,{relative:o});if(!s.isTransitioning)return!1;let p=gn(s.currentLocation.pathname,c)||s.currentLocation.pathname,g=gn(s.nextLocation.pathname,c)||s.nextLocation.pathname;return qr(d.pathname,g)!=null||qr(d.pathname,p)!=null}var ue=function(){return ue=Object.assign||function(o){for(var s,c=1,d=arguments.length;c<d;c++){s=arguments[c];for(var p in s)Object.prototype.hasOwnProperty.call(s,p)&&(o[p]=s[p])}return o},ue.apply(this,arguments)};function Yr(l,o,s){if(s||arguments.length===2)for(var c=0,d=o.length,p;c<d;c++)(p||!(c in o))&&(p||(p=Array.prototype.slice.call(o,0,c)),p[c]=o[c]);return l.concat(p||Array.prototype.slice.call(o))}var Rt="-ms-",cl="-moz-",xt="-webkit-",Um="comm",Jr="rule",Gs="decl",fx="@import",km="@keyframes",dx="@layer",Hm=Math.abs,Qs=String.fromCharCode,Ns=Object.assign;function hx(l,o){return Jt(l,0)^45?(((o<<2^Jt(l,0))<<2^Jt(l,1))<<2^Jt(l,2))<<2^Jt(l,3):0}function qm(l){return l.trim()}function mn(l,o){return(l=o.exec(l))?l[0]:l}function lt(l,o,s){return l.replace(o,s)}function _r(l,o,s){return l.indexOf(o,s)}function Jt(l,o){return l.charCodeAt(o)|0}function Ia(l,o,s){return l.slice(o,s)}function Ve(l){return l.length}function Ym(l){return l.length}function ol(l,o){return o.push(l),l}function mx(l,o){return l.map(o).join("")}function nm(l,o){return l.filter(function(s){return!mn(s,o)})}var $r=1,Pa=1,Lm=0,_e=0,kt=0,li="";function Wr(l,o,s,c,d,p,g,S){return{value:l,root:o,parent:s,type:c,props:d,children:p,line:$r,column:Pa,length:g,return:"",siblings:S}}function Ln(l,o){return Ns(Wr("",null,null,"",null,null,0,l.siblings),l,{length:-l.length},o)}function Wa(l){for(;l.root;)l=Ln(l.root,{children:[l]});ol(l,l.siblings)}function px(){return kt}function gx(){return kt=_e>0?Jt(li,--_e):0,Pa--,kt===10&&(Pa=1,$r--),kt}function He(){return kt=_e<Lm?Jt(li,_e++):0,Pa++,kt===10&&(Pa=1,$r++),kt}function sa(){return Jt(li,_e)}function Br(){return _e}function Fr(l,o){return Ia(li,l,o)}function Ts(l){switch(l){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function xx(l){return $r=Pa=1,Lm=Ve(li=l),_e=0,[]}function vx(l){return li="",l}function Ss(l){return qm(Fr(_e-1,Ds(l===91?l+2:l===40?l+1:l)))}function bx(l){for(;(kt=sa())&&kt<33;)He();return Ts(l)>2||Ts(kt)>3?"":" "}function yx(l,o){for(;--o&&He()&&!(kt<48||kt>102||kt>57&&kt<65||kt>70&&kt<97););return Fr(l,Br()+(o<6&&sa()==32&&He()==32))}function Ds(l){for(;He();)switch(kt){case l:return _e;case 34:case 39:l!==34&&l!==39&&Ds(kt);break;case 40:l===41&&Ds(l);break;case 92:He();break}return _e}function wx(l,o){for(;He()&&l+kt!==57;)if(l+kt===84&&sa()===47)break;return"/*"+Fr(o,_e-1)+"*"+Qs(l===47?l:He())}function Sx(l){for(;!Ts(sa());)He();return Fr(l,_e)}function zx(l){return vx(Ur("",null,null,null,[""],l=xx(l),0,[0],l))}function Ur(l,o,s,c,d,p,g,S,x){for(var h=0,b=0,T=g,M=0,k=0,H=0,q=1,X=1,U=1,Z=0,Y="",F=d,V=p,I=c,J=Y;X;)switch(H=Z,Z=He()){case 40:if(H!=108&&Jt(J,T-1)==58){_r(J+=lt(Ss(Z),"&","&\f"),"&\f",Hm(h?S[h-1]:0))!=-1&&(U=-1);break}case 34:case 39:case 91:J+=Ss(Z);break;case 9:case 10:case 13:case 32:J+=bx(H);break;case 92:J+=yx(Br()-1,7);continue;case 47:switch(sa()){case 42:case 47:ol(Ax(wx(He(),Br()),o,s,x),x);break;default:J+="/"}break;case 123*q:S[h++]=Ve(J)*U;case 125*q:case 59:case 0:switch(Z){case 0:case 125:X=0;case 59+b:U==-1&&(J=lt(J,/\f/g,"")),k>0&&Ve(J)-T&&ol(k>32?im(J+";",c,s,T-1,x):im(lt(J," ","")+";",c,s,T-2,x),x);break;case 59:J+=";";default:if(ol(I=am(J,o,s,h,b,d,S,Y,F=[],V=[],T,p),p),Z===123)if(b===0)Ur(J,o,I,I,F,p,T,S,V);else switch(M===99&&Jt(J,3)===110?100:M){case 100:case 108:case 109:case 115:Ur(l,I,I,c&&ol(am(l,I,I,0,0,d,S,Y,d,F=[],T,V),V),d,V,T,S,c?F:V);break;default:Ur(J,I,I,I,[""],V,0,S,V)}}h=b=k=0,q=U=1,Y=J="",T=g;break;case 58:T=1+Ve(J),k=H;default:if(q<1){if(Z==123)--q;else if(Z==125&&q++==0&&gx()==125)continue}switch(J+=Qs(Z),Z*q){case 38:U=b>0?1:(J+="\f",-1);break;case 44:S[h++]=(Ve(J)-1)*U,U=1;break;case 64:sa()===45&&(J+=Ss(He())),M=sa(),b=T=Ve(Y=J+=Sx(Br())),Z++;break;case 45:H===45&&Ve(J)==2&&(q=0)}}return p}function am(l,o,s,c,d,p,g,S,x,h,b,T){for(var M=d-1,k=d===0?p:[""],H=Ym(k),q=0,X=0,U=0;q<c;++q)for(var Z=0,Y=Ia(l,M+1,M=Hm(X=g[q])),F=l;Z<H;++Z)(F=qm(X>0?k[Z]+" "+Y:lt(Y,/&\f/g,k[Z])))&&(x[U++]=F);return Wr(l,o,s,d===0?Jr:S,x,h,b,T)}function Ax(l,o,s,c){return Wr(l,o,s,Um,Qs(px()),Ia(l,2,-2),0,c)}function im(l,o,s,c,d){return Wr(l,o,s,Gs,Ia(l,0,c),Ia(l,c+1,-1),c,d)}function Gm(l,o,s){switch(hx(l,o)){case 5103:return xt+"print-"+l+l;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return xt+l+l;case 4789:return cl+l+l;case 5349:case 4246:case 4810:case 6968:case 2756:return xt+l+cl+l+Rt+l+l;case 5936:switch(Jt(l,o+11)){case 114:return xt+l+Rt+lt(l,/[svh]\w+-[tblr]{2}/,"tb")+l;case 108:return xt+l+Rt+lt(l,/[svh]\w+-[tblr]{2}/,"tb-rl")+l;case 45:return xt+l+Rt+lt(l,/[svh]\w+-[tblr]{2}/,"lr")+l}case 6828:case 4268:case 2903:return xt+l+Rt+l+l;case 6165:return xt+l+Rt+"flex-"+l+l;case 5187:return xt+l+lt(l,/(\w+).+(:[^]+)/,xt+"box-$1$2"+Rt+"flex-$1$2")+l;case 5443:return xt+l+Rt+"flex-item-"+lt(l,/flex-|-self/g,"")+(mn(l,/flex-|baseline/)?"":Rt+"grid-row-"+lt(l,/flex-|-self/g,""))+l;case 4675:return xt+l+Rt+"flex-line-pack"+lt(l,/align-content|flex-|-self/g,"")+l;case 5548:return xt+l+Rt+lt(l,"shrink","negative")+l;case 5292:return xt+l+Rt+lt(l,"basis","preferred-size")+l;case 6060:return xt+"box-"+lt(l,"-grow","")+xt+l+Rt+lt(l,"grow","positive")+l;case 4554:return xt+lt(l,/([^-])(transform)/g,"$1"+xt+"$2")+l;case 6187:return lt(lt(lt(l,/(zoom-|grab)/,xt+"$1"),/(image-set)/,xt+"$1"),l,"")+l;case 5495:case 3959:return lt(l,/(image-set\([^]*)/,xt+"$1$`$1");case 4968:return lt(lt(l,/(.+:)(flex-)?(.*)/,xt+"box-pack:$3"+Rt+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+xt+l+l;case 4200:if(!mn(l,/flex-|baseline/))return Rt+"grid-column-align"+Ia(l,o)+l;break;case 2592:case 3360:return Rt+lt(l,"template-","")+l;case 4384:case 3616:return s&&s.some(function(c,d){return o=d,mn(c.props,/grid-\w+-end/)})?~_r(l+(s=s[o].value),"span",0)?l:Rt+lt(l,"-start","")+l+Rt+"grid-row-span:"+(~_r(s,"span",0)?mn(s,/\d+/):+mn(s,/\d+/)-+mn(l,/\d+/))+";":Rt+lt(l,"-start","")+l;case 4896:case 4128:return s&&s.some(function(c){return mn(c.props,/grid-\w+-start/)})?l:Rt+lt(lt(l,"-end","-span"),"span ","")+l;case 4095:case 3583:case 4068:case 2532:return lt(l,/(.+)-inline(.+)/,xt+"$1$2")+l;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(Ve(l)-1-o>6)switch(Jt(l,o+1)){case 109:if(Jt(l,o+4)!==45)break;case 102:return lt(l,/(.+:)(.+)-([^]+)/,"$1"+xt+"$2-$3$1"+cl+(Jt(l,o+3)==108?"$3":"$2-$3"))+l;case 115:return~_r(l,"stretch",0)?Gm(lt(l,"stretch","fill-available"),o,s)+l:l}break;case 5152:case 5920:return lt(l,/(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/,function(c,d,p,g,S,x,h){return Rt+d+":"+p+h+(g?Rt+d+"-span:"+(S?x:+x-+p)+h:"")+l});case 4949:if(Jt(l,o+6)===121)return lt(l,":",":"+xt)+l;break;case 6444:switch(Jt(l,Jt(l,14)===45?18:11)){case 120:return lt(l,/(.+:)([^;\s!]+)(;|(\s+)?!.+)?/,"$1"+xt+(Jt(l,14)===45?"inline-":"")+"box$3$1"+xt+"$2$3$1"+Rt+"$2box$3")+l;case 100:return lt(l,":",":"+Rt)+l}break;case 5719:case 2647:case 2135:case 3927:case 2391:return lt(l,"scroll-","scroll-snap-")+l}return l}function Lr(l,o){for(var s="",c=0;c<l.length;c++)s+=o(l[c],c,l,o)||"";return s}function Ex(l,o,s,c){switch(l.type){case dx:if(l.children.length)break;case fx:case Gs:return l.return=l.return||l.value;case Um:return"";case km:return l.return=l.value+"{"+Lr(l.children,c)+"}";case Jr:if(!Ve(l.value=l.props.join(",")))return""}return Ve(s=Lr(l.children,c))?l.return=l.value+"{"+s+"}":""}function jx(l){var o=Ym(l);return function(s,c,d,p){for(var g="",S=0;S<o;S++)g+=l[S](s,c,d,p)||"";return g}}function Rx(l){return function(o){o.root||(o=o.return)&&l(o)}}function Nx(l,o,s,c){if(l.length>-1&&!l.return)switch(l.type){case Gs:l.return=Gm(l.value,l.length,s);return;case km:return Lr([Ln(l,{value:lt(l.value,"@","@"+xt)})],c);case Jr:if(l.length)return mx(s=l.props,function(d){switch(mn(d,c=/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":Wa(Ln(l,{props:[lt(d,/:(read-\w+)/,":"+cl+"$1")]})),Wa(Ln(l,{props:[d]})),Ns(l,{props:nm(s,c)});break;case"::placeholder":Wa(Ln(l,{props:[lt(d,/:(plac\w+)/,":"+xt+"input-$1")]})),Wa(Ln(l,{props:[lt(d,/:(plac\w+)/,":"+cl+"$1")]})),Wa(Ln(l,{props:[lt(d,/:(plac\w+)/,Rt+"input-$1")]})),Wa(Ln(l,{props:[d]})),Ns(l,{props:nm(s,c)});break}return""})}}var Tx={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},ye={},ti=typeof process<"u"&&ye!==void 0&&(ye.REACT_APP_SC_ATTR||ye.SC_ATTR)||"data-styled",Qm="active",Xm="data-styled-version",Ir="6.1.19",Xs=`/*!sc*/
`,Gr=typeof window<"u"&&typeof document<"u",Dx=!!(typeof SC_DISABLE_SPEEDY=="boolean"?SC_DISABLE_SPEEDY:typeof process<"u"&&ye!==void 0&&ye.REACT_APP_SC_DISABLE_SPEEDY!==void 0&&ye.REACT_APP_SC_DISABLE_SPEEDY!==""?ye.REACT_APP_SC_DISABLE_SPEEDY!=="false"&&ye.REACT_APP_SC_DISABLE_SPEEDY:typeof process<"u"&&ye!==void 0&&ye.SC_DISABLE_SPEEDY!==void 0&&ye.SC_DISABLE_SPEEDY!==""&&ye.SC_DISABLE_SPEEDY!=="false"&&ye.SC_DISABLE_SPEEDY),Pr=Object.freeze([]),ei=Object.freeze({});function Ox(l,o,s){return s===void 0&&(s=ei),l.theme!==s.theme&&l.theme||o||s.theme}var Vm=new Set(["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","track","u","ul","use","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"]),Cx=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,Mx=/(^-|-$)/g;function lm(l){return l.replace(Cx,"-").replace(Mx,"")}var _x=/(a)(d)/gi,Dr=52,rm=function(l){return String.fromCharCode(l+(l>25?39:97))};function Os(l){var o,s="";for(o=Math.abs(l);o>Dr;o=o/Dr|0)s=rm(o%Dr)+s;return(rm(o%Dr)+s).replace(_x,"$1-$2")}var zs,Zm=5381,Fa=function(l,o){for(var s=o.length;s;)l=33*l^o.charCodeAt(--s);return l},Km=function(l){return Fa(Zm,l)};function Bx(l){return Os(Km(l)>>>0)}function Ux(l){return l.displayName||l.name||"Component"}function As(l){return typeof l=="string"&&!0}var Jm=typeof Symbol=="function"&&Symbol.for,$m=Jm?Symbol.for("react.memo"):60115,kx=Jm?Symbol.for("react.forward_ref"):60112,Hx={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},qx={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},Wm={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},Yx=((zs={})[kx]={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},zs[$m]=Wm,zs);function om(l){return("type"in(o=l)&&o.type.$$typeof)===$m?Wm:"$$typeof"in l?Yx[l.$$typeof]:Hx;var o}var Lx=Object.defineProperty,Gx=Object.getOwnPropertyNames,cm=Object.getOwnPropertySymbols,Qx=Object.getOwnPropertyDescriptor,Xx=Object.getPrototypeOf,sm=Object.prototype;function Fm(l,o,s){if(typeof o!="string"){if(sm){var c=Xx(o);c&&c!==sm&&Fm(l,c,s)}var d=Gx(o);cm&&(d=d.concat(cm(o)));for(var p=om(l),g=om(o),S=0;S<d.length;++S){var x=d[S];if(!(x in qx||s&&s[x]||g&&x in g||p&&x in p)){var h=Qx(o,x);try{Lx(l,x,h)}catch{}}}}return l}function ni(l){return typeof l=="function"}function Vs(l){return typeof l=="object"&&"styledComponentId"in l}function ca(l,o){return l&&o?"".concat(l," ").concat(o):l||o||""}function um(l,o){if(l.length===0)return"";for(var s=l[0],c=1;c<l.length;c++)s+=l[c];return s}function ul(l){return l!==null&&typeof l=="object"&&l.constructor.name===Object.name&&!("props"in l&&l.$$typeof)}function Cs(l,o,s){if(s===void 0&&(s=!1),!s&&!ul(l)&&!Array.isArray(l))return o;if(Array.isArray(o))for(var c=0;c<o.length;c++)l[c]=Cs(l[c],o[c]);else if(ul(o))for(var c in o)l[c]=Cs(l[c],o[c]);return l}function Zs(l,o){Object.defineProperty(l,"toString",{value:o})}function ml(l){for(var o=[],s=1;s<arguments.length;s++)o[s-1]=arguments[s];return new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(l," for more information.").concat(o.length>0?" Args: ".concat(o.join(", ")):""))}var Vx=(function(){function l(o){this.groupSizes=new Uint32Array(512),this.length=512,this.tag=o}return l.prototype.indexOfGroup=function(o){for(var s=0,c=0;c<o;c++)s+=this.groupSizes[c];return s},l.prototype.insertRules=function(o,s){if(o>=this.groupSizes.length){for(var c=this.groupSizes,d=c.length,p=d;o>=p;)if((p<<=1)<0)throw ml(16,"".concat(o));this.groupSizes=new Uint32Array(p),this.groupSizes.set(c),this.length=p;for(var g=d;g<p;g++)this.groupSizes[g]=0}for(var S=this.indexOfGroup(o+1),x=(g=0,s.length);g<x;g++)this.tag.insertRule(S,s[g])&&(this.groupSizes[o]++,S++)},l.prototype.clearGroup=function(o){if(o<this.length){var s=this.groupSizes[o],c=this.indexOfGroup(o),d=c+s;this.groupSizes[o]=0;for(var p=c;p<d;p++)this.tag.deleteRule(c)}},l.prototype.getGroup=function(o){var s="";if(o>=this.length||this.groupSizes[o]===0)return s;for(var c=this.groupSizes[o],d=this.indexOfGroup(o),p=d+c,g=d;g<p;g++)s+="".concat(this.tag.getRule(g)).concat(Xs);return s},l})(),kr=new Map,Qr=new Map,Hr=1,Or=function(l){if(kr.has(l))return kr.get(l);for(;Qr.has(Hr);)Hr++;var o=Hr++;return kr.set(l,o),Qr.set(o,l),o},Zx=function(l,o){Hr=o+1,kr.set(l,o),Qr.set(o,l)},Kx="style[".concat(ti,"][").concat(Xm,'="').concat(Ir,'"]'),Jx=new RegExp("^".concat(ti,'\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')),$x=function(l,o,s){for(var c,d=s.split(","),p=0,g=d.length;p<g;p++)(c=d[p])&&l.registerName(o,c)},Wx=function(l,o){for(var s,c=((s=o.textContent)!==null&&s!==void 0?s:"").split(Xs),d=[],p=0,g=c.length;p<g;p++){var S=c[p].trim();if(S){var x=S.match(Jx);if(x){var h=0|parseInt(x[1],10),b=x[2];h!==0&&(Zx(b,h),$x(l,b,x[3]),l.getTag().insertRules(h,d)),d.length=0}else d.push(S)}}},fm=function(l){for(var o=document.querySelectorAll(Kx),s=0,c=o.length;s<c;s++){var d=o[s];d&&d.getAttribute(ti)!==Qm&&(Wx(l,d),d.parentNode&&d.parentNode.removeChild(d))}};function Fx(){return typeof __webpack_nonce__<"u"?__webpack_nonce__:null}var Im=function(l){var o=document.head,s=l||o,c=document.createElement("style"),d=(function(S){var x=Array.from(S.querySelectorAll("style[".concat(ti,"]")));return x[x.length-1]})(s),p=d!==void 0?d.nextSibling:null;c.setAttribute(ti,Qm),c.setAttribute(Xm,Ir);var g=Fx();return g&&c.setAttribute("nonce",g),s.insertBefore(c,p),c},Ix=(function(){function l(o){this.element=Im(o),this.element.appendChild(document.createTextNode("")),this.sheet=(function(s){if(s.sheet)return s.sheet;for(var c=document.styleSheets,d=0,p=c.length;d<p;d++){var g=c[d];if(g.ownerNode===s)return g}throw ml(17)})(this.element),this.length=0}return l.prototype.insertRule=function(o,s){try{return this.sheet.insertRule(s,o),this.length++,!0}catch{return!1}},l.prototype.deleteRule=function(o){this.sheet.deleteRule(o),this.length--},l.prototype.getRule=function(o){var s=this.sheet.cssRules[o];return s&&s.cssText?s.cssText:""},l})(),Px=(function(){function l(o){this.element=Im(o),this.nodes=this.element.childNodes,this.length=0}return l.prototype.insertRule=function(o,s){if(o<=this.length&&o>=0){var c=document.createTextNode(s);return this.element.insertBefore(c,this.nodes[o]||null),this.length++,!0}return!1},l.prototype.deleteRule=function(o){this.element.removeChild(this.nodes[o]),this.length--},l.prototype.getRule=function(o){return o<this.length?this.nodes[o].textContent:""},l})(),tv=(function(){function l(o){this.rules=[],this.length=0}return l.prototype.insertRule=function(o,s){return o<=this.length&&(this.rules.splice(o,0,s),this.length++,!0)},l.prototype.deleteRule=function(o){this.rules.splice(o,1),this.length--},l.prototype.getRule=function(o){return o<this.length?this.rules[o]:""},l})(),dm=Gr,ev={isServer:!Gr,useCSSOMInjection:!Dx},Pm=(function(){function l(o,s,c){o===void 0&&(o=ei),s===void 0&&(s={});var d=this;this.options=ue(ue({},ev),o),this.gs=s,this.names=new Map(c),this.server=!!o.isServer,!this.server&&Gr&&dm&&(dm=!1,fm(this)),Zs(this,function(){return(function(p){for(var g=p.getTag(),S=g.length,x="",h=function(T){var M=(function(U){return Qr.get(U)})(T);if(M===void 0)return"continue";var k=p.names.get(M),H=g.getGroup(T);if(k===void 0||!k.size||H.length===0)return"continue";var q="".concat(ti,".g").concat(T,'[id="').concat(M,'"]'),X="";k!==void 0&&k.forEach(function(U){U.length>0&&(X+="".concat(U,","))}),x+="".concat(H).concat(q,'{content:"').concat(X,'"}').concat(Xs)},b=0;b<S;b++)h(b);return x})(d)})}return l.registerId=function(o){return Or(o)},l.prototype.rehydrate=function(){!this.server&&Gr&&fm(this)},l.prototype.reconstructWithOptions=function(o,s){return s===void 0&&(s=!0),new l(ue(ue({},this.options),o),this.gs,s&&this.names||void 0)},l.prototype.allocateGSInstance=function(o){return this.gs[o]=(this.gs[o]||0)+1},l.prototype.getTag=function(){return this.tag||(this.tag=(o=(function(s){var c=s.useCSSOMInjection,d=s.target;return s.isServer?new tv(d):c?new Ix(d):new Px(d)})(this.options),new Vx(o)));var o},l.prototype.hasNameForId=function(o,s){return this.names.has(o)&&this.names.get(o).has(s)},l.prototype.registerName=function(o,s){if(Or(o),this.names.has(o))this.names.get(o).add(s);else{var c=new Set;c.add(s),this.names.set(o,c)}},l.prototype.insertRules=function(o,s,c){this.registerName(o,s),this.getTag().insertRules(Or(o),c)},l.prototype.clearNames=function(o){this.names.has(o)&&this.names.get(o).clear()},l.prototype.clearRules=function(o){this.getTag().clearGroup(Or(o)),this.clearNames(o)},l.prototype.clearTag=function(){this.tag=void 0},l})(),nv=/&/g,av=/^\s*\/\/.*$/gm;function tp(l,o){return l.map(function(s){return s.type==="rule"&&(s.value="".concat(o," ").concat(s.value),s.value=s.value.replaceAll(",",",".concat(o," ")),s.props=s.props.map(function(c){return"".concat(o," ").concat(c)})),Array.isArray(s.children)&&s.type!=="@keyframes"&&(s.children=tp(s.children,o)),s})}function iv(l){var o,s,c,d=ei,p=d.options,g=p===void 0?ei:p,S=d.plugins,x=S===void 0?Pr:S,h=function(M,k,H){return H.startsWith(s)&&H.endsWith(s)&&H.replaceAll(s,"").length>0?".".concat(o):M},b=x.slice();b.push(function(M){M.type===Jr&&M.value.includes("&")&&(M.props[0]=M.props[0].replace(nv,s).replace(c,h))}),g.prefix&&b.push(Nx),b.push(Ex);var T=function(M,k,H,q){k===void 0&&(k=""),H===void 0&&(H=""),q===void 0&&(q="&"),o=q,s=k,c=new RegExp("\\".concat(s,"\\b"),"g");var X=M.replace(av,""),U=zx(H||k?"".concat(H," ").concat(k," { ").concat(X," }"):X);g.namespace&&(U=tp(U,g.namespace));var Z=[];return Lr(U,jx(b.concat(Rx(function(Y){return Z.push(Y)})))),Z};return T.hash=x.length?x.reduce(function(M,k){return k.name||ml(15),Fa(M,k.name)},Zm).toString():"",T}var lv=new Pm,Ms=iv(),ep=Me.createContext({shouldForwardProp:void 0,styleSheet:lv,stylis:Ms});ep.Consumer;Me.createContext(void 0);function hm(){return A.useContext(ep)}var rv=(function(){function l(o,s){var c=this;this.inject=function(d,p){p===void 0&&(p=Ms);var g=c.name+p.hash;d.hasNameForId(c.id,g)||d.insertRules(c.id,g,p(c.rules,g,"@keyframes"))},this.name=o,this.id="sc-keyframes-".concat(o),this.rules=s,Zs(this,function(){throw ml(12,String(c.name))})}return l.prototype.getName=function(o){return o===void 0&&(o=Ms),this.name+o.hash},l})(),ov=function(l){return l>="A"&&l<="Z"};function mm(l){for(var o="",s=0;s<l.length;s++){var c=l[s];if(s===1&&c==="-"&&l[0]==="-")return l;ov(c)?o+="-"+c.toLowerCase():o+=c}return o.startsWith("ms-")?"-"+o:o}var np=function(l){return l==null||l===!1||l===""},ap=function(l){var o,s,c=[];for(var d in l){var p=l[d];l.hasOwnProperty(d)&&!np(p)&&(Array.isArray(p)&&p.isCss||ni(p)?c.push("".concat(mm(d),":"),p,";"):ul(p)?c.push.apply(c,Yr(Yr(["".concat(d," {")],ap(p),!1),["}"],!1)):c.push("".concat(mm(d),": ").concat((o=d,(s=p)==null||typeof s=="boolean"||s===""?"":typeof s!="number"||s===0||o in Tx||o.startsWith("--")?String(s).trim():"".concat(s,"px")),";")))}return c};function ua(l,o,s,c){if(np(l))return[];if(Vs(l))return[".".concat(l.styledComponentId)];if(ni(l)){if(!ni(p=l)||p.prototype&&p.prototype.isReactComponent||!o)return[l];var d=l(o);return ua(d,o,s,c)}var p;return l instanceof rv?s?(l.inject(s,c),[l.getName(c)]):[l]:ul(l)?ap(l):Array.isArray(l)?Array.prototype.concat.apply(Pr,l.map(function(g){return ua(g,o,s,c)})):[l.toString()]}function cv(l){for(var o=0;o<l.length;o+=1){var s=l[o];if(ni(s)&&!Vs(s))return!1}return!0}var sv=Km(Ir),uv=(function(){function l(o,s,c){this.rules=o,this.staticRulesId="",this.isStatic=(c===void 0||c.isStatic)&&cv(o),this.componentId=s,this.baseHash=Fa(sv,s),this.baseStyle=c,Pm.registerId(s)}return l.prototype.generateAndInjectStyles=function(o,s,c){var d=this.baseStyle?this.baseStyle.generateAndInjectStyles(o,s,c):"";if(this.isStatic&&!c.hash)if(this.staticRulesId&&s.hasNameForId(this.componentId,this.staticRulesId))d=ca(d,this.staticRulesId);else{var p=um(ua(this.rules,o,s,c)),g=Os(Fa(this.baseHash,p)>>>0);if(!s.hasNameForId(this.componentId,g)){var S=c(p,".".concat(g),void 0,this.componentId);s.insertRules(this.componentId,g,S)}d=ca(d,g),this.staticRulesId=g}else{for(var x=Fa(this.baseHash,c.hash),h="",b=0;b<this.rules.length;b++){var T=this.rules[b];if(typeof T=="string")h+=T;else if(T){var M=um(ua(T,o,s,c));x=Fa(x,M+b),h+=M}}if(h){var k=Os(x>>>0);s.hasNameForId(this.componentId,k)||s.insertRules(this.componentId,k,c(h,".".concat(k),void 0,this.componentId)),d=ca(d,k)}}return d},l})(),ip=Me.createContext(void 0);ip.Consumer;var Es={};function fv(l,o,s){var c=Vs(l),d=l,p=!As(l),g=o.attrs,S=g===void 0?Pr:g,x=o.componentId,h=x===void 0?(function(F,V){var I=typeof F!="string"?"sc":lm(F);Es[I]=(Es[I]||0)+1;var J="".concat(I,"-").concat(Bx(Ir+I+Es[I]));return V?"".concat(V,"-").concat(J):J})(o.displayName,o.parentComponentId):x,b=o.displayName,T=b===void 0?(function(F){return As(F)?"styled.".concat(F):"Styled(".concat(Ux(F),")")})(l):b,M=o.displayName&&o.componentId?"".concat(lm(o.displayName),"-").concat(o.componentId):o.componentId||h,k=c&&d.attrs?d.attrs.concat(S).filter(Boolean):S,H=o.shouldForwardProp;if(c&&d.shouldForwardProp){var q=d.shouldForwardProp;if(o.shouldForwardProp){var X=o.shouldForwardProp;H=function(F,V){return q(F,V)&&X(F,V)}}else H=q}var U=new uv(s,M,c?d.componentStyle:void 0);function Z(F,V){return(function(I,J,wt){var vt=I.attrs,ne=I.componentStyle,ie=I.defaultProps,Lt=I.foldedComponentIds,$e=I.styledComponentId,We=I.target,Gt=Me.useContext(ip),D=hm(),G=I.shouldForwardProp||D.shouldForwardProp,P=Ox(J,Gt,ie)||ei,ct=(function(st,et,Qt){for(var gt,It=ue(ue({},et),{className:void 0,theme:Qt}),Qn=0;Qn<st.length;Qn+=1){var Fe=ni(gt=st[Qn])?gt(It):gt;for(var ze in Fe)It[ze]=ze==="className"?ca(It[ze],Fe[ze]):ze==="style"?ue(ue({},It[ze]),Fe[ze]):Fe[ze]}return et.className&&(It.className=ca(It.className,et.className)),It})(vt,J,P),y=ct.as||We,B={};for(var L in ct)ct[L]===void 0||L[0]==="$"||L==="as"||L==="theme"&&ct.theme===P||(L==="forwardedAs"?B.as=ct.forwardedAs:G&&!G(L,y)||(B[L]=ct[L]));var Q=(function(st,et){var Qt=hm(),gt=st.generateAndInjectStyles(et,Qt.styleSheet,Qt.stylis);return gt})(ne,ct),W=ca(Lt,$e);return Q&&(W+=" "+Q),ct.className&&(W+=" "+ct.className),B[As(y)&&!Vm.has(y)?"class":"className"]=W,wt&&(B.ref=wt),A.createElement(y,B)})(Y,F,V)}Z.displayName=T;var Y=Me.forwardRef(Z);return Y.attrs=k,Y.componentStyle=U,Y.displayName=T,Y.shouldForwardProp=H,Y.foldedComponentIds=c?ca(d.foldedComponentIds,d.styledComponentId):"",Y.styledComponentId=M,Y.target=c?d.target:l,Object.defineProperty(Y,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(F){this._foldedDefaultProps=c?(function(V){for(var I=[],J=1;J<arguments.length;J++)I[J-1]=arguments[J];for(var wt=0,vt=I;wt<vt.length;wt++)Cs(V,vt[wt],!0);return V})({},d.defaultProps,F):F}}),Zs(Y,function(){return".".concat(Y.styledComponentId)}),p&&Fm(Y,l,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),Y}function pm(l,o){for(var s=[l[0]],c=0,d=o.length;c<d;c+=1)s.push(o[c],l[c+1]);return s}var gm=function(l){return Object.assign(l,{isCss:!0})};function dv(l){for(var o=[],s=1;s<arguments.length;s++)o[s-1]=arguments[s];if(ni(l)||ul(l))return gm(ua(pm(Pr,Yr([l],o,!0))));var c=l;return o.length===0&&c.length===1&&typeof c[0]=="string"?ua(c):gm(ua(pm(c,o)))}function _s(l,o,s){if(s===void 0&&(s=ei),!o)throw ml(1,o);var c=function(d){for(var p=[],g=1;g<arguments.length;g++)p[g-1]=arguments[g];return l(o,s,dv.apply(void 0,Yr([d],p,!1)))};return c.attrs=function(d){return _s(l,o,ue(ue({},s),{attrs:Array.prototype.concat(s.attrs,d).filter(Boolean)}))},c.withConfig=function(d){return _s(l,o,ue(ue({},s),d))},c}var lp=function(l){return _s(fv,l)},pt=lp;Vm.forEach(function(l){pt[l]=lp(l)});const hv=pt.div`
  width: 100%;
  min-height: 100vh;
  margin-top: 10px;
...
`;function mv(){return f.jsx(hv,{children:f.jsxs("section",{className:"content-section",children:[f.jsx("p",{className:"text1",children:"Quer assistir? Informe seu email para criar ou reiniciar sua assinatura."}),f.jsxs("div",{className:"content-controls",children:[f.jsx("input",{type:"text",placeholder:"Email"}),f.jsxs("button",{children:["Vamos Lá ",f.jsx("span",{children:">"})," "]})]}),f.jsx("div",{className:"doubt-container",children:f.jsxs("p",{className:"doubt",children:["Dúvidas? Ligue para ",f.jsx("span",{children:"0800 591 2876"})]})}),f.jsxs("div",{className:"p1",children:[f.jsx("p",{children:"Perguntas Frequentes"}),f.jsx("p",{children:"Central de Ajuda"}),f.jsx("p",{children:"Conta"}),f.jsx("p",{children:"Media Center"})]}),f.jsxs("div",{className:"p2",children:[f.jsx("p",{children:"Relações com Investidores"}),f.jsx("p",{children:"Carreiras"}),f.jsx("p",{children:"Resgatar cartão pré-pago"}),f.jsx("p",{children:"Comprar cartão pré-pago"})]}),f.jsxs("div",{className:"p3",children:[f.jsx("p",{children:"Formas de assistir"}),f.jsx("p",{children:"Termos de Uso"}),f.jsx("p",{children:"Privacidade"}),f.jsx("p",{children:"Preferências de cookies"})]}),f.jsxs("div",{className:"p4",children:[f.jsx("p",{children:"Informações corporativas"}),f.jsx("p",{children:"Entre em contato"}),f.jsx("p",{children:"Teste de velocidade"}),f.jsx("p",{children:"Avisos legais"})]}),f.jsx("div",{className:"p5",children:f.jsx("p",{children:"Só na Netflix"})}),f.jsxs("div",{className:"final",children:[f.jsxs("select",{children:[f.jsx("option",{value:"portugues",children:"Português"}),f.jsx("option",{value:"ingles",children:"Inglês"})]}),f.jsx("p",{children:"Netflix Brasil"})]})]})})}const pv=pt.div`
  width: 100%;
  padding: 20px;
  padding-bottom: 35px;
  display: flex;
...
`,Ks="/Movies-ReactJS/assets/Logonetflix-cJzkA86F.png";function gv(){const l=Yt(),o=()=>{l("/sign-in")};return f.jsxs(pv,{children:[f.jsx("img",{src:Ks,alt:"Logo da Netflix"}),f.jsxs("div",{className:"user-controls",children:[f.jsxs("select",{children:[f.jsx("option",{value:"portugues",children:"Português"}),f.jsx("option",{value:"ingles",children:"Inglês"})]}),f.jsx("button",{onClick:o,children:"Entrar"})]})]})}const xv="/Movies-ReactJS/assets/background-G0Np5zM9.jpg",vv=pt.div`
...
@media screen and (min-width:1200px){
  ...
  `;function bv(){return f.jsx(f.Fragment,{children:f.jsxs(vv,{children:[f.jsx(gv,{}),f.jsxs("section",{className:"content-section",children:[f.jsx("h1",{children:"Filmes, Séries e muito mais, sem limites"}),f.jsx("p",{children:"Assista onde quiser. Cancele quando quiser"}),f.jsx("p",{className:"p2",children:"Quer assistir? Informe seu email para criar ou reiniciar sua assinatura."}),f.jsxs("div",{className:"controls",children:[f.jsx("input",{type:"text",placeholder:"Email"}),f.jsxs("button",{children:["Vamos Lá ",f.jsx("span",{children:">"})]})]})]})]})})}const yv=pt.div`
  width: 100%;
  height: 200px;
...
`,wv="/Movies-ReactJS/assets/pipoca-C290b5xr.png";function Sv(){return f.jsx(yv,{children:f.jsxs("section",{className:"content-section",children:[f.jsx("img",{src:wv,alt:"Imagem da pipoca"}),f.jsxs("div",{className:"content",children:[f.jsx("h2",{children:"A Netflix que você adora por apenas R$ 20,90."}),f.jsx("p",{children:"Assine o plano Padrão com anúncios."}),f.jsx(Ls,{to:"/",children:" Saiba Mais > "})]})]})})}const zv=pt.div`
  width: 100%;
  height: 80vh;
  background-color: black;
  color: white;
...
`;function qv(){return f.jsx(Hv,{children:f.jsx("img",{src:Ks,alt:"Netflix-Logo"})})}const xm="/Movies-ReactJS/assets/back01-BieqImTc.jpg",Yv=pt.div`
  width: 100%;
  height: 100vh;
  background-color: black;
...
`;function Lv(){const[l,o]=A.useState(""),[s,c]=A.useState(""),d=Yt(),p=()=>{d("/")},g=()=>{if(!l.trim()||!s.trim()){alert("Preencha todos os campos!");return}d("/main-app")};return f.jsx(f.Fragment,{children:f.jsxs(Yv,{children:[f.jsx(qv,{}),f.jsx("div",{className:"container",children:f.jsxs("div",{className:"content-section",children:[f.jsx("h2",{children:"Entrar"}),f.jsx("input",{type:"text",placeholder:"E-mail ou número de celular",value:l,onChange:S=>o(S.target.value)}),f.jsx("input",{type:"text",placeholder:"Senha",value:s,onChange:S=>c(S.target.value)}),f.jsx("button",{onClick:g,children:"Entrar"}),f.jsx("p",{className:"separate",children:"OU"}),f.jsxs("div",{className:"forgot-password",children:[f.jsx("p",{children:"Use um código de login"}),f.jsx("a",{href:"#",children:"Esqueceu sua senha?"})]}),f.jsxs("div",{className:"remember",children:[f.jsx("input",{type:"checkbox"}),f.jsx("label",{children:"Lembra de Mim?"})]}),f.jsxs("div",{className:"sign-up-now",children:[f.jsx("p",{children:"Novo na Netflix"}),f.jsx("p",{onClick:p,children:f.jsx("strong",{children:"Assine Já"})})]})]})})]})})}const Gv=pt.div`
...
`;function Qv(){return f.jsx(Gv,{children:f.jsxs("footer",{className:"content-section",children:[f.jsx("p",{className:"doubt",children:"Dúvidas? Ligue para 0800 591 2876 (ligação gratuita)"}),f.jsxs("div",{className:"questions",children:[f.jsxs("div",{className:"q1",children:[f.jsx("p",{children:"Perguntas frequentes"}),f.jsx("p",{children:"Termos de Uso"}),f.jsx("p",{children:"Preferências de cookies"})]}),f.jsxs("div",{className:"q2",children:[f.jsx("p",{children:"Central de ajuda"}),f.jsx("p",{children:"Privacidade"}),f.jsx("p",{children:"Informações corporativas"})]}),f.jsxs("select",{children:[f.jsx("option",{value:"portugues",children:"Português"}),f.jsx("option",{value:"ingles",children:"Inglês"})]})]})]})})}function Xv(){return f.jsxs(f.Fragment,{children:[f.jsx(Lv,{}),f.jsx(Qv,{})]})}const Vv=pt.div`
  width: 100%;
  background-color: black;
  color: white;
  padding: 10px 20px;
...
`;function Zv(){const l=Yt(),o=()=>l("/"),[s,c]=A.useState(!1),d=()=>c(!s);return f.jsxs(Vv,{children:[f.jsxs("div",{className:"content-section",children:[f.jsxs("div",{className:"p1",children:[f.jsx("img",{src:Ks,alt:"Logo Netflix"}),f.jsxs("div",{className:"desktop-menu",children:[f.jsx("p",{children:"Início"}),f.jsx("p",{children:"Séries"}),f.jsx("p",{children:"Filmes"}),f.jsx("p",{children:"Novos & Populares"}),f.jsx("p",{children:"Minha Lista"})]})]}),f.jsxs("div",{className:"p2",children:[f.jsx("button",{onClick:o,children:"Sair"}),f.jsx("div",{className:"btn-mobile",onClick:d,children:f.jsx("p",{children:"☰"})})]})]}),f.jsxs("div",{className:`side-menu ${s?"open":""}`,children:[f.jsx("div",{className:"close-btn",onClick:d,children:"×"}),f.jsx("p",{children:"Início"}),f.jsx("p",{children:"Séries"}),f.jsx("p",{children:"Filmes"}),f.jsx("p",{children:"Novos & Populares"}),f.jsx("p",{children:"Minha Lista"})]}),s&&f.jsx("div",{className:"overlay",onClick:d})]})}const Kv=pt.div`
  position: relative;
  width: 100%;
  height: 48vh;
...
`;function Jv(){const[l,o]=A.useState(""),[s,c]=A.useState(""),[d,p]=A.useState(),[g,S]=A.useState(""),[x,h]=A.useState(""),[b,T]=A.useState(""),M=Yt(),k=(H,q)=>{M(`/details/${H}`,{state:{type:q}})};return A.useEffect(()=>{(async()=>{const q="ee96350ded551df8af41839e03615c58";try{const U=await(await fetch(`https://api.themoviedb.org/3/tv/66732?api_key=${q}&language=pt-BR`)).json();o(U.name),p(U.number_of_seasons),c(U.overview);const Y=await(await fetch(`https://api.themoviedb.org/3/tv/66732/images?api_key=${q}`)).json(),F=Y.posters[30],V=Y.backdrops[2],I=Y.backdrops[30];S(`https://image.tmdb.org/t/p/w500${F.file_path}`),T(`https://image.tmdb.org/t/p/original${V.file_path}`),h(`https://image.tmdb.org/t/p/original${I.file_path}`)}catch(X){console.error("Erro ao buscar banner:",X)}})()},[]),f.jsx(Kv,{bg:g,bg2:b,bg3:x,children:f.jsxs("div",{className:"content-section",children:[f.jsx("div",{className:"title",children:f.jsx("h1",{children:l.toUpperCase()})}),f.jsxs("div",{className:"desc",children:[f.jsxs("p",{className:"season",children:["Assista a temporada ",d]}),f.jsxs("p",{children:[s.slice(0,85),"..."]}),f.jsxs("div",{className:"btn",children:[f.jsx("a",{href:"https://youtu.be/iKZyYdwS3Wg?si=_PmLTcQVMn-G5chD",target:"_blank",children:f.jsx("button",{className:"play",children:" ▶ Assistir"})}),f.jsx("button",{onClick:()=>k(66732,"tv"),className:"more",children:"Mais Informações"})]})]})]})})}const $v=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function lb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${s}&with_networks=213&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=h=>{c(`/details/${h}`,{state:{type:"tv"}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(ib,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{className:"saga-title",children:f.jsx("strong",{children:"Originais Netflix"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.name})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const rb=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function ob(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=h=>{c(`/details/${h}`)},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(rb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{className:"saga-title",children:f.jsx("strong",{children:"Em Alta"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const cb=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function sb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/movie?with_genres=35&api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=h=>{c(`/details/${h}`)},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(cb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{className:"saga-title",children:f.jsx("strong",{children:"Comédia"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const ub=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function fb(){const[l,o]=A.useState([]),s=Yt(),c=A.useRef(null),d="ee96350ded551df8af41839e03615c58",p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/movie?with_genres=27&api_key=${d}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=h=>{s(`/details/${h}`)},S=()=>{c.current&&c.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{c.current&&c.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(ub,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{className:"saga-title",children:f.jsx("strong",{children:"Terror"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:c,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const db=pt.div`
  width: 100%;
  background-color: black;
  color: white;
...
`;function hb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=h=>{c(`/details/${h}`,{state:{type:"tv"}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(db,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{className:"saga-title",children:f.jsx("strong",{children:"Séries de TV"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.name||h.title})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const mb=pt.div`
  width: 100%;
  background-color: black;
  color: white;
  padding-bottom: 0px;
...
`;function pb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?query=star%20wars&api_key=${s}&language=pt-BR&page=1`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(mb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("h2",{className:"main-title",children:"Sagas Populares"}),f.jsx("p",{className:"saga-title",children:f.jsx("strong",{children:"Universo Star Wars"})}),f.jsxs("div",{className:"saga-block carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const gb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function xb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=Indiana%20Jones`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(gb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{children:f.jsx("strong",{children:"Universo Indiana Jones"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const vb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function bb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=Jurassic%20Park`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(vb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{children:f.jsx("strong",{children:"Universo Jurassic Park"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const yb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function wb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=Harry%20Potter`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(yb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{children:f.jsx("strong",{children:"Universo Harry Potter"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const Sb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function zb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${s}&language=pt-BR&query=The%20Lord%20Of%20Rings`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(Sb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{children:f.jsx("strong",{children:"Universo Senhor dos Anéis"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const Ab=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function Eb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=Yt(),d=A.useRef(null),p=async()=>{const b=await(await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${s}&language=pt-BR&with_companies=420`)).json();o(b.results)};A.useEffect(()=>{p()},[]);const g=(h,b)=>{c(`/details/${h}`,{state:{type:b}})},S=()=>{d.current&&d.current.scrollBy({left:-500,behavior:"smooth"})},x=()=>{d.current&&d.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(Ab,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{children:f.jsx("strong",{children:"Universo Marvel"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:S,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:d,children:l.filter(h=>h.poster_path).map(h=>f.jsx("div",{className:"card",onClick:()=>g(h.id,h.media_type),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${h.poster_path}`,alt:h.title||h.name})},h.id))}),f.jsx("button",{className:"arrow right",onClick:x,children:f.jsx(Se,{})})]})]})})}const jb=pt.div`
  width: 100%;
  height: 100%;
  background-color: black;
  color: white;
...
`;function Rb(){const[l,o]=A.useState([]),s="ee96350ded551df8af41839e03615c58",c=[268,49026,297802,297761,272,141052,297762,474395,155,209112,464052,1042305],d=Yt(),p=A.useRef(null),g=async()=>{try{const b=c.map(M=>fetch(`https://api.themoviedb.org/3/movie/${M}?api_key=${s}&language=pt-BR`).then(k=>k.json())),T=await Promise.all(b);o(T.filter(M=>M.poster_path))}catch(b){console.error("Erro ao buscar filmes DC:",b)}};A.useEffect(()=>{g()},[]);const S=(b,T)=>{d(`/details/${b}`,{state:{type:T}})},x=()=>{p.current&&p.current.scrollBy({left:-500,behavior:"smooth"})},h=()=>{p.current&&p.current.scrollBy({left:500,behavior:"smooth"})};return f.jsx(jb,{children:f.jsxs("div",{className:"content-section",children:[f.jsx("p",{children:f.jsx("strong",{children:"Universo DC"})}),f.jsxs("div",{className:"carousel-container",children:[f.jsx("button",{className:"arrow left",onClick:x,children:f.jsx(we,{})}),f.jsx("div",{className:"cards",ref:p,children:l.map(b=>f.jsx("div",{className:"card",onClick:()=>S(b.id,b.media_type),children:f.jsx("img",{src:`https://image.tmdb.org/t/p/w500${b.poster_path}`,alt:b.title||b.name})},b.id))}),f.jsx("button",{className:"arrow right",onClick:h,children:f.jsx(Se,{})})]})]})})}const Nb=pt.div`
  max-height: 700px;
  width: 100%;
  background-color: black;
  color: white;
...
`,kb="/Movies-ReactJS/assets/logo-yAEqU2JB.png";function Hb(){const{id:l}=x1(),{state:o}=Gn(),s=o?.type||"movie",[c,d]=A.useState(null),[p,g]=A.useState(null),[S,x]=A.useState("Livre"),[h,b]=A.useState([]),T="ee96350ded551df8af41839e03615c58",M=Yt(),k=()=>M("/main-app");if(A.useEffect(()=>{(async()=>{try{const Y=await fetch(`https://api.themoviedb.org/3/${s}/${l}?api_key=${T}&language=pt-BR`);if(!Y.ok)throw new Error("Não encontrado");const F=await Y.json();if(d(F),s==="movie"){const I=await fetch(`https://api.themoviedb.org/3/movie/${l}/release_dates?api_key=${T}`);if(I.ok){const wt=(await I.json()).results?.find(vt=>vt.iso_3166_1==="BR");wt?.release_dates?.length>0&&x(wt.release_dates[0].certification||"Livre")}}s==="movie"||s==="tv"&&g(F.number_of_seasons);const V=await fetch(`https://api.themoviedb.org/3/${s}/${l}/credits?api_key=${T}&language=pt-BR`);if(V.ok){const I=await V.json();b(I.cast?.slice(0,5)||[])}}catch(Y){console.error("Erro ao buscar detalhes:",Y),d(null)}})()},[l,s]),!c)return f.jsx(Bb,{children:f.jsxs("p",{children:["CARREGANDO",f.jsx("span",{className:"dot",children:"."}),f.jsx("span",{className:"dot",children:"."}),f.jsx("span",{className:"dot",children:"."})]})});const H=s==="movie"?c.title:c.name,q=c.backdrop_path?`https://image.tmdb.org/t/p/original${c.backdrop_path}`:"",X=c.poster_path?`https://image.tmdb.org/t/p/original${c.poster_path}`:"",U=async()=>{try{const Z=await fetch(`https://api.themoviedb.org/3/${s}/${l}/videos?api_key=${T}&language=pt-BR`);if(!Z.ok)throw new Error("Vídeo não encontrado");const F=(await Z.json()).results.find(V=>V.type==="Trailer"&&V.site==="YouTube");if(F){const V=`https://www.youtube.com/watch?v=${F.key}`;window.open(V,"_blank")}else alert("Trailer não disponível.")}catch(Z){console.error(Z),alert("Erro ao buscar trailer.")}};return f.jsxs(Ub,{bg:q,bg2:X,children:[f.jsx("div",{className:"img",onClick:k,children:f.jsx("img",{src:kb,alt:"Logo da Netflix"})}),f.jsxs("div",{className:"info",children:[f.jsx("h1",{children:H.length>23?H.toUpperCase().slice(0,19)+"...":H.toUpperCase()}),f.jsxs("div",{className:"info-extras",children:[f.jsx("p",{children:s==="movie"?c.release_date?.slice(0,4):c.first_air_date?.slice(0,4)}),f.jsx("p",{children:S}),s==="movie"?f.jsx("p",{children:c.runtime?`${Math.floor(c.runtime/60)}h ${c.runtime%60}min`:"N/A"}):f.jsxs("p",{children:["Temporadas: ",c.number_of_seasons||"N/A"]})]})]}),f.jsx("div",{className:"description",children:f.jsxs("p",{children:[c.overview?.slice(0,120)||"Sem descrição","..."]})}),f.jsxs("div",{className:"btns",children:[f.jsx("button",{className:"play",onClick:U,children:"▶ Assistir"}),f.jsx("button",{className:"more-info",children:"ℹ Mais Informações"})]}),f.jsxs("div",{className:"casting",children:[f.jsx("h3",{children:"Elenco:"}),f.jsx("p",{children:h?.slice(0,3).map((Z,Y)=>f.jsxs("span",{children:[Z.name,Y<2?", ":"..."]},Z.cast_id||Z.id))})]}),f.jsxs("div",{className:"genres",children:[f.jsx("h3",{children:"Gênero:"}),f.jsxs("p",{children:[c.genres?.map(Z=>Z.name).join(", ").slice(0,30),c.genres?.map(Z=>Z.name).join(", ").length>30?"...":""]})]})]})}function qb(){return f.jsx(f.Fragment,{children:f.jsx(ex,{basename:"/Movies-ReactJS",children:f.jsxs(C1,{children:[f.jsx(rl,{path:"/",element:f.jsx(kv,{})}),f.jsx(rl,{path:"/sign-in",element:f.jsx(Xv,{})}),f.jsx(rl,{path:"main-app",element:f.jsx(_b,{})}),f.jsx(rl,{path:"details/:id",element:f.jsx(Hb,{})})]})})})}Lg.createRoot(document.getElementById("root")).render(f.jsx(A.StrictMode,{children:f.jsx(qb,{})}));
